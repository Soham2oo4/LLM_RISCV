# 1 "/tools/toolchain/newlib/libgloss/libnosys/_exit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/libgloss/libnosys/_exit.c" 2
...
# 4 "/tools/toolchain/newlib/libgloss/libnosys/_exit.c" 2
# 1 "/tools/toolchain/newlib/libgloss/libnosys/./config.h" 1
# 5 "/tools/toolchain/newlib/libgloss/libnosys/_exit.c" 2
...
# 6 "/tools/toolchain/newlib/libgloss/libnosys/_exit.c" 2
# 1 "/tools/toolchain/newlib/newlib/libc/include/_syslist.h" 1 3
# 7 "/tools/toolchain/newlib/libgloss/libnosys/_exit.c" 2
