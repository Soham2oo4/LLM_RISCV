# 1 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c" 2




# 1 "/tools/toolchain/newlib/libgloss/libnosys/./config.h" 1
# 6 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c" 2
...
# 7 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c" 2
# 1 "/tools/toolchain/newlib/newlib/libc/include/_syslist.h" 1 3
# 8 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c" 2
...
# 9 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c" 2

extern int errno;

# 1 "/tools/toolchain/newlib/libgloss/libnosys/./warning.h" 1
# 12 "/tools/toolchain/newlib/libgloss/libnosys/symlink.c" 2
