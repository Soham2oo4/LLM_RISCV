# 1 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
# 273 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
# 1 "/tools/toolchain/newlib/newlib/libc/machine/codasip/newlib.h" 1 3
# 274 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 275 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 276 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
# 1 "/tools/toolchain/newlib/newlib/libc/include/stdio.h" 1 3
# 29 "/tools/toolchain/newlib/newlib/libc/include/stdio.h" 3
# 1 "/tools/toolchain/newlib/newlib/libc/include/_ansi.h" 1 3
# 30 "/tools/toolchain/newlib/newlib/libc/include/stdio.h" 2 3
...
# 60 "/tools/toolchain/newlib/newlib/libc/include/stdio.h" 3
...
# 61 "/tools/toolchain/newlib/newlib/libc/include/stdio.h" 2 3
...
# 277 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 278 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 279 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
_Noreturn void
 quick_exit(int);
# 280 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 281 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 282 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 283 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 284 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
...
# 38 "/tools/toolchain/newlib/newlib/libc/time/./../locale/setlocale.h" 2
...
int __messages_load_locale (struct __locale_t *, const char *, void *,
       const char *);
# 285 "/tools/toolchain/newlib/newlib/libc/time/strftime.c" 2
# 346 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
static int
...
# 671 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
static size_t
...

{
 ...
 {
   alt = *format++;
# 732 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
 }
      else if (*format == 'O')
 {
   alt = *format++;
# 745 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
 }
...
recurse:
 ...
 case 'C':
   {
# 856 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
       {
  char *fmt = "%s%.*d";
  char *pos = "";
 ...
 case 'd':
 case 'e':
# 901 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
  ...
  sign = 1;
     ...
     *fmt++ = '%';
     ...
     len = sniprintf (&s[count], maxsize - count, fmtbuf, width, p_year);
          ...
          break;
 case 'H':
# 1021 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
 case 'k':
   len = sniprintf (&s[count], maxsize - count,
     *format == 'k' ? "%2d" : "%.2d",
     tim_p->tm_hour);
 ...
 case 'P':
   ...
   for (i = 0; i < ctloclen; i++)
     {
       if (count < maxsize - 1)
  s[count++] = (*format == 'P' ? __extension__ ({ __typeof__ ((int)(unsigned char)(ctloc[i])) __x = ((int)(unsigned char)(ctloc[i])); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})
       : ctloc[i]);
       else
  return 0;
     }
 ...
 case 'R':
     ...
     tim_p->tm_hour, tim_p->tm_min);
          ...
          break;
 case 's':
# 1120 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
   {
     long offset = 0;
...
# 1144 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
 ...
 case 'T':
     ...
     tim_p->tm_hour, tim_p->tm_min, tim_p->tm_sec);
          ...
          break;
 case 'u':
# 1196 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
          if (count < maxsize - 1)
            {
              if (tim_p->tm_wday == 0)
                s[count++] = '7';
...
# 1240 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
       len = sniprintf (&s[count], maxsize - count, "%.2d", week);
            if (len < 0 || (count += len) >= maxsize) return 0;
   }
          break;
 case 'w':
# 1255 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
   if (count < maxsize - 1)
            s[count++] = '0' + tim_p->tm_wday;
   else
     return 0;
 ...
 case 'y':
...

  {
   ...
   break;
 case 'Y':
# 1306 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
     {
       char fmtbuf[10], *fmt = fmtbuf;
       int sign = tim_p->tm_year < -1900;
...
# 1356 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
       __tzinfo_type *tz = __gettzinfo ();
...
{
# 1445 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
...
{
# 1465 "/tools/toolchain/newlib/newlib/libc/time/strftime.c"
