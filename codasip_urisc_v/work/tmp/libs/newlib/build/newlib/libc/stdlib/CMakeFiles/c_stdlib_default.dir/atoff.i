# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/atoff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/atoff.c" 2
...
_Noreturn void
 quick_exit(int);
# 2 "/tools/toolchain/newlib/newlib/libc/stdlib/atoff.c" 2
