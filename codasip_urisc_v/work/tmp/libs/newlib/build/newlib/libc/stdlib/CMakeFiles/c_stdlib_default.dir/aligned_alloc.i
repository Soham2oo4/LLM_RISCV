# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/aligned_alloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/aligned_alloc.c" 2
# 29 "/tools/toolchain/newlib/newlib/libc/stdlib/aligned_alloc.c"
...
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/aligned_alloc.c" 2
...
_Noreturn void
 quick_exit(int);
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/aligned_alloc.c" 2

void *
aligned_alloc (size_t align, size_t size)
{
  return _memalign_r (_impure_ptr, align, size);
}
