# 1 "/tools/toolchain/newlib/newlib/libc/string/strstr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strstr.c" 2
# 59 "/tools/toolchain/newlib/newlib/libc/string/strstr.c"
...
# 60 "/tools/toolchain/newlib/newlib/libc/string/strstr.c" 2
...
# 61 "/tools/toolchain/newlib/newlib/libc/string/strstr.c" 2
# 95 "/tools/toolchain/newlib/newlib/libc/string/strstr.c"
  ...
  if (memcmp (needle, needle + period, suffix) == 0)
    {
      ...
      size_t memory = 0;
      j = 0;
      while ((((j) <= (haystack_len) - (needle_len)) || ((haystack_len) += strnlen ((haystack) + (haystack_len), (needle_len) | 2048), ((j) <= (haystack_len) - (needle_len)))))
 {
...
# 96 "/tools/toolchain/newlib/newlib/libc/string/strstr.c" 2
...
# 143 "/tools/toolchain/newlib/newlib/libc/string/strstr.c"
char *
