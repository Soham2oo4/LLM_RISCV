# 1 "/tools/toolchain/newlib/newlib/libc/string/strpbrk.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strpbrk.c" 2
# 25 "/tools/toolchain/newlib/newlib/libc/string/strpbrk.c"
...
# 26 "/tools/toolchain/newlib/newlib/libc/string/strpbrk.c" 2
