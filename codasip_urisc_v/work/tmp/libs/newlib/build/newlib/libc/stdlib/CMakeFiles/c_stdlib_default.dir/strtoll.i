# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
# 120 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c"
...
# 121 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
...
# 6 "/tools/toolchain/newlib/newlib/libc/include/limits.h" 2 3
...
# 122 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
...
# 123 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
...
# 124 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
...
_Noreturn void
 quick_exit(int);
# 125 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
...
# 126 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2
...
int __messages_load_locale (struct __locale_t *, const char *, void *,
       const char *);
# 127 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c" 2




static long long
_strtoll_l (struct _reent *rptr, const char *restrict nptr,
     char **restrict endptr, int base, locale_t loc)
{
 ...
 if (base == 0)
  base = c == '0' ? 8 : 10;
# 180 "/tools/toolchain/newlib/newlib/libc/stdlib/strtoll.c"
...
long long
strtoll_l (const char *restrict s, char **restrict ptr, int base,
    locale_t loc)
{
 return _strtoll_l (_impure_ptr, s, ptr, base, loc);
}

long long
strtoll (const char *restrict s,
 char **restrict ptr,
 int base)
{
 return _strtoll_l (_impure_ptr, s, ptr, base, __get_current_locale ());
}
