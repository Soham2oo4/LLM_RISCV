# 1 "/tools/toolchain/newlib/newlib/libc/string/bcopy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/bcopy.c" 2
# 23 "/tools/toolchain/newlib/newlib/libc/string/bcopy.c"
...
# 24 "/tools/toolchain/newlib/newlib/libc/string/bcopy.c" 2
