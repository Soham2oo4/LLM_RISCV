# 1 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
# 62 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c"
...
# 63 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 64 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 65 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 66 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 67 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 68 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 69 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
_Noreturn void
 quick_exit(int);
# 70 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 72 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c" 2
...
# 118 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c"
  if (fp->_flags == 0)
    fp->_flags = 0x0020;
  else
    {
 ...
 fp->_close (ptr, fp->_cookie);
  ...
  if (file != ((void*)0))
    ...
    {
# 159 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c"
      f = -1;
# 171 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c"
      if (f < 0)
 {
   e = 9;
   if (fp->_close != ((void*)0))
...
# 186 "/tools/toolchain/newlib/newlib/libc/stdio/freopen.c"
  if (fp->_flags & 0x0080)
...
FILE *
freopen (const char *restrict file,
       const char *restrict mode,
       register FILE *restrict fp)
{
