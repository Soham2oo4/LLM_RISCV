# 1 "/tools/toolchain/newlib/newlib/libc/ctype/tolower_l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/ctype/tolower_l.c" 2
...
# 2 "/tools/toolchain/newlib/newlib/libc/ctype/tolower_l.c" 2
...
# 3 "/tools/toolchain/newlib/newlib/libc/ctype/tolower_l.c" 2
# 12 "/tools/toolchain/newlib/newlib/libc/ctype/tolower_l.c"
int
tolower_l (int c, struct __locale_t *locale)
{
# 34 "/tools/toolchain/newlib/newlib/libc/ctype/tolower_l.c"
  return ((((__locale_ctype_ptr_l(locale)+sizeof(""[c]))[(int)(c)])&(01|02))==01) ? (c) - 'A' + 'a' : c;
