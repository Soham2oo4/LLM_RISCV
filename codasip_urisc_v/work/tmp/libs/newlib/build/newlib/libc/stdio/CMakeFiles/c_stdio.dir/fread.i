# 1 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c" 2
# 83 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c"
...
# 84 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c" 2
...
# 85 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c" 2
...
# 86 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c" 2
...
# 87 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c" 2
...
# 88 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c" 2
# 143 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c"
size_t
       ...
       FILE * restrict fp)
{
      ...
      while (resid > (r = fp->_r))
 {
   ...
   if (__srefill_r (ptr, fp))
     {
# 238 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c"
       if (!(fp->_flags2 & 0x0001)) (((fp)->_flags & 0x0200) ? 0 : ((void) 0));;
       return (total - resid) / size;
     }
 }
...
# 255 "/tools/toolchain/newlib/newlib/libc/stdio/fread.c"
  if (!(fp->_flags2 & 0x0001)) (((fp)->_flags & 0x0200) ? 0 : ((void) 0)); };
  return count;
}
