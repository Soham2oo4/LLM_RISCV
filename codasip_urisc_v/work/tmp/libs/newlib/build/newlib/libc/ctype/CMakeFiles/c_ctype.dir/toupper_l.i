# 1 "/tools/toolchain/newlib/newlib/libc/ctype/toupper_l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/ctype/toupper_l.c" 2
...
# 2 "/tools/toolchain/newlib/newlib/libc/ctype/toupper_l.c" 2
...
# 3 "/tools/toolchain/newlib/newlib/libc/ctype/toupper_l.c" 2
# 13 "/tools/toolchain/newlib/newlib/libc/ctype/toupper_l.c"
int
toupper_l (int c, struct __locale_t *locale)
{
# 36 "/tools/toolchain/newlib/newlib/libc/ctype/toupper_l.c"
  return ((((__locale_ctype_ptr_l(locale)+sizeof(""[c]))[(int)(c)])&(01|02))==02) ? c - 'a' + 'A' : c;
