...
.LBB1_63:                               //  %if.else355
	...
	lw x16, 56 ( sp )               //  4-byte Folded Reload
	mv x11, x0
	blt x11, x22, .LBB1_166
.LBB1_64:                               //  %if.else355
                                        //    in Loop: Header=BB1_1 Depth=1
	mv x12, x22
	add x17, x0, 100
	add x11, x0, -1900
	blt x24, x11, .LBB1_168
.LBB1_167:                              //  %if.else355
                                        //    in Loop: Header=BB1_1 Depth=1
	mv x12, x22
.LBB1_168:                              //  %if.else355
...
.LBB1_169:                              //  %if.end362
                                        //    in Loop: Header=BB1_1 Depth=1
	xor x12, x10, -1
	bltu x0, x12, .LBB1_161
.LBB1_170:                              //  %if.then366
                                        //    in Loop: Header=BB1_1 Depth=1
	add x10, x0, 99
	add x27, x27, -1
	hackaton_custom_instr_c x12, x17, x27
	add x21, x10, x12
...
.LBB1_177:                              //  %if.end599
	...
	add x10, x10, x11
	add x11, x0, 365
	hackaton_custom_instr_c x11, x11, x21
	add x13, x13, %lo( -25550 )
	add x11, x13, x11
	sra x13, x11, 31&31
	add x13, x13, x10
	add x10, x11, x12
...
.LBB1_179:                              //  %if.then694
	...
	add x10, x23, x18
	add x11, x0, 55
.LBB1_180:                              //  %sw.epilogthread-pre-split
                                        //    in Loop: Header=BB1_1 Depth=1
	sb x11, 0 ( x10 )
.LBB1_181:                              //  %sw.epilogthread-pre-split
                                        //    in Loop: Header=BB1_1 Depth=1
	add x10, x23, x19
	add x19, x10, 1
	jal x0, .LBB1_218
