# 1 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
# 68 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c"
...
# 69 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
...
# 71 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
...
# 72 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
...
# 73 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
...
# 74 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
...
# 75 "/tools/toolchain/newlib/newlib/libc/ctype/towupper.c" 2
...
towupper (wint_t c)
{
  ...
  return c < 0x00ff ? (wint_t)(__extension__ ({ __typeof__ ((int)c) __x = ((int)c); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;})) : c;
