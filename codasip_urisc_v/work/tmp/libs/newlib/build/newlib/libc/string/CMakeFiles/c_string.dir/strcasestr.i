# 1 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c" 2
# 69 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c"
...
# 70 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c" 2
...
# 72 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c" 2
...
# 73 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c" 2
# 83 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c"
...
# 34 "/tools/toolchain/newlib/newlib/libc/string/./str-two-way.h" 2
...
# 112 "/tools/toolchain/newlib/newlib/libc/string/./str-two-way.h"
  ...
  while (j + k < needle_len)
    {
      a = __extension__ ({ __typeof__ (needle[j + k]) __x = (needle[j + k]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
      b = __extension__ ({ __typeof__ (needle[(size_t)(max_suffix + k)]) __x = (needle[(size_t)(max_suffix + k)]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
      if (a < b)
 {
  ...
  *period = p;
  ...
  while (j + k < needle_len)
    {
      a = __extension__ ({ __typeof__ (needle[j + k]) __x = (needle[j + k]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
      b = __extension__ ({ __typeof__ (needle[max_suffix_rev + k]) __x = (needle[max_suffix_rev + k]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
      if (b < a)
 {
        ...
        const unsigned char *needle, size_t needle_len)
{
      ...
      while ((!memchr ((haystack) + (haystack_len), '\0', (j) + (needle_len) - (haystack_len)) && ((haystack_len) = (j) + (needle_len))))
 {
   ...
   while (i < needle_len && (__extension__ ({ __typeof__ (needle[i]) __x = (needle[i]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})
        == __extension__ ({ __typeof__ (haystack[i + j]) __x = (haystack[i + j]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})))
     ++i;
   if (needle_len <= i)
     {

       i = suffix - 1;
       while (memory < i + 1 && (__extension__ ({ __typeof__ (needle[i]) __x = (needle[i]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})
     == __extension__ ({ __typeof__ (haystack[i + j]) __x = (haystack[i + j]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})))
  --i;
       if (i + 1 < memory + 1)
   ...
   if (needle_len <= i)
     {
       ...
       i = suffix - 1;
       while (i != (4294967295U) && (__extension__ ({ __typeof__ (needle[i]) __x = (needle[i]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})
           == __extension__ ({ __typeof__ (haystack[i + j]) __x = (haystack[i + j]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})))
  --i;
       if (i == (4294967295U))
  return (char *) (haystack + j);
...
__attribute__ ((__noinline__)) static char *
       ...
       const unsigned char *needle, size_t needle_len)
{
  ...
  for (i = 0; i < needle_len; i++)
    shift_table[__extension__ ({ __typeof__ (needle[i]) __x = (needle[i]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})] = needle_len - i - 1;
      ...
      while ((!memchr ((haystack) + (haystack_len), '\0', (j) + (needle_len) - (haystack_len)) && ((haystack_len) = (j) + (needle_len))))
 {
   ...
   shift = shift_table[__extension__ ({ __typeof__ (haystack[j + needle_len - 1]) __x = (haystack[j + needle_len - 1]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})];
   if (0 < shift)
     {
       if (memory && shift < period)
  {
   ...
   i = ((suffix < memory) ? (memory) : (suffix));
   while (i < needle_len - 1 && (__extension__ ({ __typeof__ (needle[i]) __x = (needle[i]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})
     == __extension__ ({ __typeof__ (haystack[i + j]) __x = (haystack[i + j]); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})))
     ++i;
   if (needle_len - 1 <= i)
     {
...
# 87 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c" 2
...
strcasestr (const char *s,
 const char *find)
{
# 118 "/tools/toolchain/newlib/newlib/libc/string/strcasestr.c"
  ...
  while (*haystack && *needle)
    ok &= (__extension__ ({ __typeof__ ((unsigned char) *haystack++) __x = ((unsigned char) *haystack++); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})
    == __extension__ ({ __typeof__ ((unsigned char) *needle++) __x = ((unsigned char) *needle++); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;}));
  if (*needle)
    return ((void*)0);
  if (ok)
    return (char *) s;
