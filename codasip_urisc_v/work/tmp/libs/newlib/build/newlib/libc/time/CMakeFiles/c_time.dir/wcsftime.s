...
.LBB2_61:                               //  %if.else333
                                        //    in Loop: Header=BB2_1 Depth=1
	mv x11, x0
	blt x11, x23, .LBB2_167
.LBB2_62:                               //  %if.else333
                                        //    in Loop: Header=BB2_1 Depth=1
	mv x12, x23
	add x14, x0, 100
	add x11, x0, -1900
	blt x25, x11, .LBB2_169
.LBB2_168:                              //  %if.else333
                                        //    in Loop: Header=BB2_1 Depth=1
	mv x12, x23
.LBB2_169:                              //  %if.else333
...
.LBB2_170:                              //  %if.end340
                                        //    in Loop: Header=BB2_1 Depth=1
	xor x12, x10, -1
	bltu x0, x12, .LBB2_162
.LBB2_171:                              //  %if.then344
                                        //    in Loop: Header=BB2_1 Depth=1
	add x10, x0, 99
	add x18, x18, -1
	hackaton_custom_instr_c x12, x14, x18
	add x23, x10, x12
	bltu x0, x11, .LBB2_163
.LBB2_172:                              //  %if.else359
                                        //    in Loop: Header=BB2_1 Depth=1
	mv x11, x0
	add x10, sp, 76
	xor x12, x26, 43
	bltu x0, x12, .LBB2_165
.LBB2_173:                              //  %if.else359
                                        //    in Loop: Header=BB2_1 Depth=1
	srl x12, x23, 4&31
	sltiu x12, x12, 625
