# 1 "/tools/toolchain/newlib/newlib/libc/string/strlwr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strlwr.c" 2
# 28 "/tools/toolchain/newlib/newlib/libc/string/strlwr.c"
...
# 29 "/tools/toolchain/newlib/newlib/libc/string/strlwr.c" 2
...
# 30 "/tools/toolchain/newlib/newlib/libc/string/strlwr.c" 2
...
strlwr (char *s)
{
  ...
  for ( ; *ucs != '\0'; ucs++)
    {
      *ucs = __extension__ ({ __typeof__ (*ucs) __x = (*ucs); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
    }
  return s;
}
