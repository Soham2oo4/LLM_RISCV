# 1 "/tools/toolchain/newlib/newlib/libc/string/strncasecmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strncasecmp.c" 2
# 36 "/tools/toolchain/newlib/newlib/libc/string/strncasecmp.c"
# 1 "/tools/toolchain/newlib/newlib/libc/include/strings.h" 1 3
# 32 "/tools/toolchain/newlib/newlib/libc/include/strings.h" 3
...
# 33 "/tools/toolchain/newlib/newlib/libc/include/strings.h" 2 3
...
# 27 "/tools/toolchain/newlib/newlib/libc/include/sys/_types.h" 2 3
...
# 34 "/tools/toolchain/newlib/newlib/libc/include/strings.h" 2 3
...
# 37 "/tools/toolchain/newlib/newlib/libc/include/strings.h" 2 3
...
# 37 "/tools/toolchain/newlib/newlib/libc/string/strncasecmp.c" 2
...
# 38 "/tools/toolchain/newlib/newlib/libc/string/strncasecmp.c" 2
 ...
 size_t n)
{
  ...
  for ( ; n != 0; n--)
    {
      const int c1 = __extension__ ({ __typeof__ (*s1++) __x = (*s1++); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
      const int c2 = __extension__ ({ __typeof__ (*s2++) __x = (*s2++); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;});
      if (((d = c1 - c2) != 0) || (c2 == '\0'))
        break;
    }
  return d;
