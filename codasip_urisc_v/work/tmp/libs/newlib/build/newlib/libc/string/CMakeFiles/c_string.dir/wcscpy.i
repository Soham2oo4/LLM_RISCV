# 1 "/tools/toolchain/newlib/newlib/libc/string/wcscpy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/wcscpy.c" 2
# 56 "/tools/toolchain/newlib/newlib/libc/string/wcscpy.c"
...
# 57 "/tools/toolchain/newlib/newlib/libc/string/wcscpy.c" 2
...
# 58 "/tools/toolchain/newlib/newlib/libc/string/wcscpy.c" 2

wchar_t *
wcscpy (wchar_t *restrict s1,
