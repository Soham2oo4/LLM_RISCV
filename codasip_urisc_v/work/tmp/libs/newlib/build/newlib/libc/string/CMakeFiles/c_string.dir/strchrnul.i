# 1 "/tools/toolchain/newlib/newlib/libc/string/strchrnul.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strchrnul.c" 2
# 31 "/tools/toolchain/newlib/newlib/libc/string/strchrnul.c"
...
# 32 "/tools/toolchain/newlib/newlib/libc/string/strchrnul.c" 2
