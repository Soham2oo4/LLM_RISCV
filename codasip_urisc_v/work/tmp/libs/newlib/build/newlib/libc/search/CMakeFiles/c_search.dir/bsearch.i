# 1 "/tools/toolchain/newlib/newlib/libc/search/bsearch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/search/bsearch.c" 2
# 56 "/tools/toolchain/newlib/newlib/libc/search/bsearch.c"
...
_Noreturn void
 quick_exit(int);
# 57 "/tools/toolchain/newlib/newlib/libc/search/bsearch.c" 2
