# 1 "/tools/toolchain/newlib/newlib/libc/string/strupr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strupr.c" 2
# 28 "/tools/toolchain/newlib/newlib/libc/string/strupr.c"
...
# 29 "/tools/toolchain/newlib/newlib/libc/string/strupr.c" 2
...
# 30 "/tools/toolchain/newlib/newlib/libc/string/strupr.c" 2
...
strupr (char *s)
{
  ...
  for ( ; *ucs != '\0'; ucs++)
    {
      *ucs = __extension__ ({ __typeof__ (*ucs) __x = (*ucs); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;});
    }
  return s;
}
