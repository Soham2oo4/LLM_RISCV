# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
# 95 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
# 1 "/tools/toolchain/newlib/newlib/libc/machine/codasip/newlib.h" 1 3
# 96 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
# 121 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 122 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 123 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 124 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
_Noreturn void
 quick_exit(int);
# 125 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 126 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 127 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 128 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 129 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 132 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 133 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
...
# 134 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
# 152 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 176 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
static int
...
# 219 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c" 2
# 230 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
extern char *_dtoa_r (struct _reent *, double, int,
         int, int *, int *, char **);
# 252 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
static wchar_t *wcvt(struct _reent *, double, int, int, wchar_t *,
      int *, int, int *, wchar_t *, int);

static int wexponent(wchar_t *, int, int);
# 290 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 367 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
int
vfwprintf (FILE *restrict fp,
       const wchar_t *restrict fmt0,
       va_list ap)
{
  int result;
       ...
       va_list ap)
{
 ...
 register int flags;
 wchar_t *fmt_anchor;
# 400 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
 int ret;
 int width;
 int prec;
 wchar_t sign;
 ...
 static const wchar_t zeroes[16] =
  {L'0',L'0',L'0',L'0',L'0',L'0',L'0',L'0',
   L'0',L'0',L'0',L'0',L'0',L'0',L'0',L'0'};
# 476 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
 decimal_point = (wchar_t) *_localeconv_r (data)->decimal_point;
# 591 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 624 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
 fmt = (wchar_t *)fmt0;
 ...
 ret = 0;
# 642 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
 for (;;) {
         cp = fmt;
                while (*fmt != L'\0' && *fmt != L'%')
                    ++fmt;
...
reswitch: switch (ch) {
  ...
  case L'\'':
# 691 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
  ...
  case L'#':
   ...
   goto rflag;
  case L'*':
# 747 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
  ...
  case L'.':
   if ((ch = *fmt++) == L'*') {
# 792 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 833 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
   width = n;
   goto reswitch;
...
# 1015 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
   cp = buf;
   ...
   if (softsign)
    sign = L'-';
   break;
# 1130 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
  case L'n':
  ...
  case L'o':
   ...
   goto nosign;
  case L'p':
# 1163 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 1242 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 1392 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
...
# 1424 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
   ...
   if (ch >= L'f') {
    if ((_double_.fp) == 0) {
     ...
     if (flags & 0x400) {
      ...
      { iovp->iov_base = (char *) (&thousands_sep); iovp->iov_len = (1) * sizeof (wchar_t); uio.uio_resid += (1) * sizeof (wchar_t); iovp++; if (++uio.uio_iovcnt >= 8) { if (__sprint_r(data, fp, &uio)) goto error; iovp = iov; } };
...
# 1553 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
static wchar_t *
     ...
     wchar_t *sign, int *decpt, int ch, int *length, wchar_t *buf, int len)
{
  ...
  *sign = L'\0';
# 1583 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf.c"
 if (ch == L'a' || ch == L'A') {
