# 1 "/tools/toolchain/newlib/newlib/libc/time/lcltime_r.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/time/lcltime_r.c" 2
# 16 "/tools/toolchain/newlib/newlib/libc/time/lcltime_r.c"
...
# 17 "/tools/toolchain/newlib/newlib/libc/time/lcltime_r.c" 2

struct tm *
localtime_r (const time_t *restrict tim_p,
