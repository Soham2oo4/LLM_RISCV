...
//  %bb.0:                              //  %entry
	...
	mv x19, x11
	mv x21, x10
	hackaton_custom_instr_c x23, x20, fp
...
.LBB3_3:                                //  %land.lhs.true.lr.ph.lr.ph.lr.ph.lr.ph
	add x11, x18, 66
	sw x11, -396 ( fp )             //  4-byte Folded Spill
	lui x11, %hi( _ctype_ )
	mv x24, x0
	...
	mv x25, x24
	mv x27, x24
	sw x24, -392 ( fp )             //  4-byte Folded Spill
	sw x11, -380 ( fp )             //  4-byte Folded Spill
	sw x24, -384 ( fp )             //  4-byte Folded Spill
	sw x24, -388 ( fp )             //  4-byte Folded Spill
...
.LBB3_51:                               //  %__ssrefill_r.exit2247.thread
	...
	lbu x13, 0 ( x11 )
	beq x13, x12, .LBB3_52
.LBB3_591:                              //  %__ssrefill_r.exit2247.thread
	jal x0, .LBB3_551
.LBB3_52:                               //  %if.end54
                                        //    in Loop: Header=BB3_4 Depth=1
	add x11, x11, 1
...
.LBB3_92:                               //  %if.end223
	...
	add x10, x11, x10
	lw x10, 0 ( x10 )
	sw x24, -404 ( fp )             //  4-byte Folded Spill
	jr x10
.LBB3_93:                               //  %sw.bb224
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x23, -388 ( fp )             //  4-byte Folded Reload
	mv x24, x0
	bne x22, x24, .LBB3_95
...
.LBB3_261:                              //    in Loop: Header=BB3_4 Depth=1
	...
	sw x23, -388 ( fp )             //  4-byte Folded Spill
	beq x0, x10, .LBB3_602
.LBB3_603:                              //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_433
...
.LBB3_163:                              //    in Loop: Header=BB3_4 Depth=1
	...
	add x10, x24, x15
	and x11, x26, 256
	bltu x0, x11, .LBB3_501
.LBB3_610:                              //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_230
.LBB3_501:                              //  %if.then1416
                                        //    in Loop: Header=BB3_4 Depth=1
	bge x0, x24, .LBB3_507
.LBB3_502:                              //  %if.then1420
                                        //    in Loop: Header=BB3_4 Depth=1
	lbu x24, -1 ( x10 )
	add x23, x10, -1
	xor x10, x24, 255
	bltu x0, x10, .LBB3_503
.LBB3_611:                              //  %if.then1420
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_515
.LBB3_503:                              //  %if.end.i2505
                                        //    in Loop: Header=BB3_4 Depth=1
	lhu x10, 12 ( x18 )
	lui x11, %hi( 65503 )
	...
	lw x10, 48 ( x18 )
	beq x0, x10, .LBB3_508
.LBB3_504:                              //  %if.then6.i2509
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 52 ( x18 )
	blt x25, x10, .LBB3_506
.LBB3_505:                              //  %land.lhs.true.i2512
                                        //    in Loop: Header=BB3_4 Depth=1
	mv x10, x19
	mv x11, x18
	jal __submore
	add x15, fp, -368
	beq x0, x10, .LBB3_506
.LBB3_612:                              //  %land.lhs.true.i2512
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_515
.LBB3_506:                              //  %if.end11.i2516
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 0 ( x18 )
	add x11, x10, -1
	sw x11, 0 ( x18 )
	...
	add x10, x10, 1
	sw x10, 4 ( x18 )
	lw x24, -404 ( fp )             //  4-byte Folded Reload
	lw x25, -400 ( fp )             //  4-byte Folded Reload
	beq x23, x15, .LBB3_613
.LBB3_614:                              //  %if.end11.i2516
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_516
.LBB3_613:                              //  %if.end11.i2516
	jal x0, .LBB3_551
...
.LBB3_165:                              //  %for.body1338.preheader
	...
	add x13, x0, 77
	add x12, x11, -43
	bltu x13, x12, .LBB3_674
.LBB3_675:                              //  %for.body1338.preheader
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_168
.LBB3_674:                              //  %for.body1338.preheader
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_229
...
.LBB3_615:                              //  %while.cond750.preheader
	jal x0, .LBB3_564
...
.LBB3_216:                              //  %while.body1161
	...
	sw x10, 0 ( x18 )
	sw x11, 4 ( x18 )
	bne x22, x23, .LBB3_217
.LBB3_618:                              //  %while.body1161
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_448
.LBB3_217:                              //  %if.end1171
                                        //    in Loop: Header=BB3_216 Depth=2
...
.LBB3_227:                              //  %if.end1008
	...
	jal x0, .LBB3_469
.LBB3_507:                              //    in Loop: Header=BB3_4 Depth=1
	mv x23, x10
	lw x24, -404 ( fp )             //  4-byte Folded Reload
	lw x25, -400 ( fp )             //  4-byte Folded Reload
	beq x23, x15, .LBB3_620
.LBB3_621:                              //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_516
.LBB3_620:
	jal x0, .LBB3_551
.LBB3_231:                              //  %if.then444
...
.LBB3_256:                              //  %if.then423
	...
	or x10, x10, 32
	sh x10, 12 ( x18 )
	bltu x0, x23, .LBB3_448
	jal x0, .LBB3_572
.LBB3_257:                              //    in Loop: Header=BB3_4 Depth=1
	lw x25, -400 ( fp )             //  4-byte Folded Reload
	lbu x10, 0 ( x21 )
	sw x10, -72 ( fp )
	bltu x0, x10, .LBB3_4
...
.LBB3_258:                              //  %if.then166
	...
	bltu x0, x10, .LBB3_4
	jal x0, .LBB3_551
.LBB3_259:                              //  %__ssrefill_r.exit2368
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 16 ( x18 )
	sw x0, 4 ( x18 )
	sw x10, 0 ( x18 )
...
.LBB3_260:                              //    in Loop: Header=BB3_4 Depth=1
	...
	bltu x0, x10, .LBB3_4
	jal x0, .LBB3_551
.LBB3_508:                              //  %if.end14.i2519
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x11, 16 ( x18 )
	bltu x0, x11, .LBB3_509
.LBB3_634:                              //  %if.end14.i2519
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_512
.LBB3_509:                              //  %land.lhs.true18.i2525
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 0 ( x18 )
	bltu x11, x10, .LBB3_510
.LBB3_635:                              //  %land.lhs.true18.i2525
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_513
.LBB3_510:                              //  %land.lhs.true24.i2528
                                        //    in Loop: Header=BB3_4 Depth=1
	lbu x11, -1 ( x10 )
	beq x11, x24, .LBB3_511
.LBB3_636:                              //  %land.lhs.true24.i2528
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_513
.LBB3_511:                              //  %if.then29.i2531
                                        //    in Loop: Header=BB3_4 Depth=1
	add x10, x10, -1
	add x11, x25, 1
	sw x11, 4 ( x18 )
...
.LBB3_276:                              //  %if.end847
	...
	lbu x10, 0 ( x10 )
	beq x0, x10, .LBB3_291
.LBB3_277:                              //  %while.body853.lr.ph
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 4 ( x18 )
	lw x12, -408 ( fp )             //  4-byte Folded Reload
	beq x0, x12, .LBB3_419
.LBB3_278:                              //    in Loop: Header=BB3_4 Depth=1
	mv x25, x23
	jal x0, .LBB3_281
.LBB3_279:                              //  %if.end887.if.end899_crit_edge
                                        //    in Loop: Header=BB3_281 Depth=2
	lw x11, 0 ( x18 )
	lbu x12, 0 ( x11 )
	add x12, x12, x13
	lbu x12, 0 ( x12 )
	bltu x0, x12, .LBB3_281
.LBB3_642:                              //  %if.end887.if.end899_crit_edge
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_498
.LBB3_281:                              //  %while.body853
                                        //    Parent Loop BB3_4 Depth=1
                                        //  =>  This Inner Loop Header: Depth=2
	add x12, x11, 1
	add x10, x10, -1
...
.LBB3_283:                              //  %if.end874
	...
	add x13, fp, -328
	sw x23, 0 ( x10 )
.LBB3_284:                              //  %cleanup.cont882
                                        //    in Loop: Header=BB3_281 Depth=2
	add x22, x22, -1
	bltu x0, x22, .LBB3_285
.LBB3_644:                              //  %cleanup.cont882
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_498
.LBB3_285:                              //  %if.end887
                                        //    in Loop: Header=BB3_281 Depth=2
	lw x10, 4 ( x18 )
	blt x0, x10, .LBB3_279
.LBB3_286:                              //  %land.lhs.true891
                                        //    in Loop: Header=BB3_281 Depth=2
	lw x11, 48 ( x18 )
	bltu x0, x11, .LBB3_287
.LBB3_645:                              //  %land.lhs.true891
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_497
.LBB3_287:                              //  %if.then.i2373
                                        //    in Loop: Header=BB3_281 Depth=2
	beq x11, x9, .LBB3_289
.LBB3_288:                              //  %if.then4.i2374
                                        //    in Loop: Header=BB3_281 Depth=2
	mv x10, x19
	jal _free_r
	add x13, fp, -328
.LBB3_289:                              //  %if.end.i2378
                                        //    in Loop: Header=BB3_281 Depth=2
	lw x10, 60 ( x18 )
	sw x0, 48 ( x18 )
	sw x10, 4 ( x18 )
	bltu x0, x10, .LBB3_290
.LBB3_646:                              //  %if.end.i2378
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_497
.LBB3_290:                              //  %__ssrefill_r.exit2386.thread
                                        //    in Loop: Header=BB3_281 Depth=2
	lw x11, 56 ( x18 )
	sw x11, 0 ( x18 )
	lbu x12, 0 ( x11 )
...
.LBB3_291:                              //    in Loop: Header=BB3_4 Depth=1
	...
	sub x22, x25, x23
	beq x0, x22, .LBB3_647
.LBB3_648:                              //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_499
.LBB3_647:
	jal x0, .LBB3_563
...
.LBB3_304:                              //  %cleanup.cont1284
                                        //    in Loop: Header=BB3_301 Depth=2
	add x22, x22, -1
	bltu x0, x22, .LBB3_305
.LBB3_676:                              //  %cleanup.cont1284
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_531
.LBB3_305:                              //  %if.end1289
                                        //    in Loop: Header=BB3_301 Depth=2
...
.LBB3_361:                              //  %if.end661.us
	...
	xor x10, x23, 3
	snez x10, x10
	lw x26, -400 ( fp )             //  4-byte Folded Reload
	xor x11, x11, 4
	snez x11, x11
	or x10, x10, x11
	sub x22, x22, x10
...
.LBB3_376:                              //  %while.body1018.us.preheader
	...
	jal x0, .LBB3_546
.LBB3_412:                              //  %if.end1107.if.end1119_crit_edge
...
.LBB3_408:                              //  %if.end1039.if.then1052_crit_edge
	...
	beq x0, x10, .LBB3_410
	jal x0, .LBB3_455
.LBB3_409:                              //  %if.then1048
                                        //    in Loop: Header=BB3_401 Depth=2
	lw x10, -408 ( fp )             //  4-byte Folded Reload
	sw x0, 0 ( x10 )
	mv x10, x0
	jal iswspace
	bltu x0, x10, .LBB3_455
.LBB3_410:                              //  %if.end1065
                                        //    in Loop: Header=BB3_401 Depth=2
	lw x11, -60 ( fp )
	xor x10, x23, 3
...
.LBB3_411:                              //  %if.end1107
	...
	lw x10, 4 ( x18 )
	blt x0, x10, .LBB3_412
.LBB3_413:                              //  %land.lhs.true1111
                                        //    in Loop: Header=BB3_401 Depth=2
	lw x11, 48 ( x18 )
	beq x0, x11, .LBB3_453
.LBB3_414:                              //  %if.then.i2432
                                        //    in Loop: Header=BB3_401 Depth=2
	beq x11, x9, .LBB3_416
.LBB3_415:                              //  %if.then4.i2433
                                        //    in Loop: Header=BB3_401 Depth=2
	mv x10, x19
	jal _free_r
.LBB3_416:                              //  %if.end.i2437
                                        //    in Loop: Header=BB3_401 Depth=2
	lw x10, 60 ( x18 )
	sw x0, 48 ( x18 )
	sw x10, 4 ( x18 )
	beq x0, x10, .LBB3_453
.LBB3_417:                              //  %__ssrefill_r.exit2445.thread
                                        //    in Loop: Header=BB3_401 Depth=2
	lw x10, 56 ( x18 )
	sw x10, 0 ( x18 )
	bltu x0, x22, .LBB3_418
	jal x0, .LBB3_469
.LBB3_390:                              //    in Loop: Header=BB3_378 Depth=2
	sw x11, -408 ( fp )             //  4-byte Folded Spill
	lw x10, 4 ( x18 )
	bge x0, x10, .LBB3_395
.LBB3_394:                              //  %if.end1107.us.if.end1119.us_crit_edge
...
.LBB3_389:                              //  %if.end1097.us
	...
	sw x25, -416 ( fp )             //  4-byte Folded Spill
	jal x0, .LBB3_392
.LBB3_391:                              //    in Loop: Header=BB3_378 Depth=2
...
.LBB3_174:                              //  %sw.bb1367
                                        //    in Loop: Header=BB3_168 Depth=2
	lw x14, -384 ( fp )             //  4-byte Folded Reload
	lui x13, %hi( __ssvfiscanf_r.basefix )
	add x13, x13, %lo( __ssvfiscanf_r.basefix )
	sll x12, x14, 1&31
	add x12, x12, x13
...
.LBB3_179:                              //  %if.end1345
                                        //    in Loop: Header=BB3_168 Depth=2
	lw x13, -384 ( fp )             //  4-byte Folded Reload
	mv x12, x0
	bne x13, x12, .LBB3_181
.LBB3_180:                              //    in Loop: Header=BB3_168 Depth=2
	or x26, x26, 512
	add x13, x0, 8
	sw x13, -384 ( fp )             //  4-byte Folded Spill
.LBB3_181:                              //  %if.end1345
                                        //    in Loop: Header=BB3_168 Depth=2
	and x13, x26, 1024
...
.LBB3_230:                              //    in Loop: Header=BB3_4 Depth=1
	...
	beq x0, x10, .LBB3_517
	jal x0, .LBB3_543
.LBB3_419:                              //  %while.body853.us.preheader
                                        //    in Loop: Header=BB3_4 Depth=1
	mv x25, x0
	add x22, x22, -1
	jal x0, .LBB3_422
.LBB3_420:                              //  %if.end887.us.if.end899.us_crit_edge
                                        //    in Loop: Header=BB3_422 Depth=2
	lw x11, 0 ( x18 )
.LBB3_421:                              //  %if.end899.us
                                        //    in Loop: Header=BB3_422 Depth=2
	lbu x12, 0 ( x11 )
	add x25, x25, 1
	add x12, x12, x13
...
.LBB3_422:                              //  %while.body853.us
	...
	add x26, x25, x23
	sb x10, 0 ( x26 )
	beq x22, x25, .LBB3_450
.LBB3_423:                              //  %if.end887.us
                                        //    in Loop: Header=BB3_422 Depth=2
	lw x10, 4 ( x18 )
	blt x0, x10, .LBB3_420
.LBB3_424:                              //  %land.lhs.true891.us
                                        //    in Loop: Header=BB3_422 Depth=2
	lw x11, 48 ( x18 )
	beq x0, x11, .LBB3_496
.LBB3_425:                              //  %if.then.i2373.us
                                        //    in Loop: Header=BB3_422 Depth=2
	beq x11, x9, .LBB3_427
.LBB3_426:                              //  %if.then4.i2374.us
                                        //    in Loop: Header=BB3_422 Depth=2
	mv x10, x19
	jal _free_r
	add x13, fp, -328
.LBB3_427:                              //  %if.end.i2378.us
                                        //    in Loop: Header=BB3_422 Depth=2
	lw x10, 60 ( x18 )
	sw x0, 48 ( x18 )
	sw x10, 4 ( x18 )
	beq x0, x10, .LBB3_496
.LBB3_428:                              //  %__ssrefill_r.exit2386.thread.us
                                        //    in Loop: Header=BB3_422 Depth=2
	lw x11, 56 ( x18 )
	sw x11, 0 ( x18 )
	jal x0, .LBB3_421
...
.LBB3_448:                              //  %cleanup438.thread
	...
	sw x10, -72 ( fp )
	beq x0, x10, .LBB3_660
.LBB3_661:                              //  %cleanup438.thread
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_4
.LBB3_660:                              //  %cleanup438.thread
	jal x0, .LBB3_551
.LBB3_449:                              //  %if.then171
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, -68 ( fp )
...
.LBB3_662:                              //  %if.then171
	jal x0, .LBB3_551
.LBB3_450:                              //  %while.end900.loopexit
                                        //    in Loop: Header=BB3_4 Depth=1
	add x25, x26, 1
	sub x22, x25, x23
	bltu x0, x22, .LBB3_499
	jal x0, .LBB3_563
...
.LBB3_454:                              //    in Loop: Header=BB3_4 Depth=1
	...
	sw x10, -416 ( fp )             //  4-byte Folded Spill
	sw x11, -412 ( fp )             //  4-byte Folded Spill
	bltu x0, x24, .LBB3_480
	jal x0, .LBB3_489
.LBB3_455:                              //  %while.cond1056.preheader
                                        //    in Loop: Header=BB3_4 Depth=1
	bltu x0, x26, .LBB3_460
	jal x0, .LBB3_469
.LBB3_456:                              //  %if.end14.if.end34_crit_edge.i2408
                                        //    in Loop: Header=BB3_460 Depth=2
	lw x10, 0 ( x18 )
.LBB3_457:                              //  %if.end34.i2425
                                        //    in Loop: Header=BB3_460 Depth=2
	sw x10, 56 ( x18 )
	add x10, x0, 3
	sw x10, 52 ( x18 )
	...
	sw x10, 60 ( x18 )
	seqz x10, x0
.LBB3_458:                              //  %_sungetc_r.exit2427.sink.split
                                        //    in Loop: Header=BB3_460 Depth=2
	sw x10, 4 ( x18 )
.LBB3_459:                              //  %_sungetc_r.exit2427
                                        //    in Loop: Header=BB3_460 Depth=2
	beq x0, x26, .LBB3_469
.LBB3_460:                              //  %while.body1059
                                        //    Parent Loop BB3_4 Depth=1
                                        //  =>  This Inner Loop Header: Depth=2
	lhu x10, 12 ( x18 )
	lui x11, %hi( 65503 )
	...
	add x26, x26, -1
	beq x0, x10, .LBB3_465
.LBB3_461:                              //  %if.then6.i2395
                                        //    in Loop: Header=BB3_460 Depth=2
	lw x10, 52 ( x18 )
	lw x11, 4 ( x18 )
	blt x11, x10, .LBB3_463
.LBB3_462:                              //  %land.lhs.true.i2398
                                        //    in Loop: Header=BB3_460 Depth=2
	mv x10, x19
	mv x11, x18
	jal __submore
	bltu x0, x10, .LBB3_459
.LBB3_463:                              //  %if.end11.i2402
                                        //    in Loop: Header=BB3_460 Depth=2
	lw x10, 0 ( x18 )
	add x11, x10, -1
	sw x11, 0 ( x18 )
	sb x22, -1 ( x10 )
.LBB3_464:                              //  %_sungetc_r.exit2427.sink.split
                                        //    in Loop: Header=BB3_460 Depth=2
	lw x10, 4 ( x18 )
	add x10, x10, 1
	jal x0, .LBB3_458
.LBB3_465:                              //  %if.end14.i2405
                                        //    in Loop: Header=BB3_460 Depth=2
	lw x11, 16 ( x18 )
	beq x0, x11, .LBB3_456
.LBB3_466:                              //  %land.lhs.true18.i2411
                                        //    in Loop: Header=BB3_460 Depth=2
	lw x10, 0 ( x18 )
	bgeu x11, x10, .LBB3_457
.LBB3_467:                              //  %land.lhs.true24.i2414
                                        //    in Loop: Header=BB3_460 Depth=2
	lbu x11, -1 ( x10 )
	bne x11, x22, .LBB3_457
.LBB3_468:                              //  %if.then29.i2417
                                        //    in Loop: Header=BB3_460 Depth=2
	add x10, x10, -1
	sw x10, 0 ( x18 )
	jal x0, .LBB3_464
...
.LBB3_470:                              //    in Loop: Header=BB3_4 Depth=1
	...
	sw x10, -72 ( fp )
	beq x0, x10, .LBB3_664
.LBB3_665:                              //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_4
.LBB3_664:
	jal x0, .LBB3_551
...
.LBB3_472:                              //  %if.then1123
	...
	add x11, x10, 1
	lw x10, -416 ( fp )             //  4-byte Folded Reload
	bgeu x11, x10, .LBB3_536
.LBB3_473:                              //  %if.then1134
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 0 ( x24 )
	sll x11, x11, 2&31
	jal realloc
	beq x0, x10, .LBB3_536
.LBB3_474:                              //  %if.then1139
                                        //    in Loop: Header=BB3_4 Depth=1
	sw x10, 0 ( x24 )
	jal x0, .LBB3_536
.LBB3_475:                              //    in Loop: Header=BB3_4 Depth=1
	...
	bltu x0, x24, .LBB3_480
	jal x0, .LBB3_489
.LBB3_476:                              //  %if.end14.if.end34_crit_edge.i
...
.LBB3_477:                              //  %if.end34.i
	...
	sw x10, 60 ( x18 )
	seqz x10, x0
.LBB3_478:                              //  %_sungetc_r.exit.sink.split
                                        //    in Loop: Header=BB3_480 Depth=2
	sw x10, 4 ( x18 )
.LBB3_479:                              //  %_sungetc_r.exit
                                        //    in Loop: Header=BB3_480 Depth=2
	beq x0, x24, .LBB3_489
.LBB3_480:                              //  %while.body655
                                        //    Parent Loop BB3_4 Depth=1
                                        //  =>  This Inner Loop Header: Depth=2
	lhu x10, 12 ( x18 )
	lui x11, %hi( 65503 )
...
.LBB3_481:                              //  %if.then6.i
	...
	lw x10, 52 ( x18 )
	lw x11, 4 ( x18 )
	blt x11, x10, .LBB3_483
.LBB3_482:                              //  %land.lhs.true.i
                                        //    in Loop: Header=BB3_480 Depth=2
	mv x10, x19
	mv x11, x18
	jal __submore
	bltu x0, x10, .LBB3_479
.LBB3_483:                              //  %if.end11.i
                                        //    in Loop: Header=BB3_480 Depth=2
	lw x10, 0 ( x18 )
	add x11, x10, -1
	sw x11, 0 ( x18 )
	sb x22, -1 ( x10 )
.LBB3_484:                              //  %_sungetc_r.exit.sink.split
                                        //    in Loop: Header=BB3_480 Depth=2
	lw x10, 4 ( x18 )
	add x10, x10, 1
	jal x0, .LBB3_478
.LBB3_485:                              //  %if.end14.i
	...
	lw x11, 16 ( x18 )
	beq x0, x11, .LBB3_476
.LBB3_486:                              //  %land.lhs.true18.i
                                        //    in Loop: Header=BB3_480 Depth=2
	lw x10, 0 ( x18 )
	bgeu x11, x10, .LBB3_477
.LBB3_487:                              //  %land.lhs.true24.i
                                        //    in Loop: Header=BB3_480 Depth=2
	lbu x11, -1 ( x10 )
	bne x11, x22, .LBB3_477
.LBB3_488:                              //  %if.then29.i
                                        //    in Loop: Header=BB3_480 Depth=2
	add x10, x10, -1
	sw x10, 0 ( x18 )
	jal x0, .LBB3_484
...
.LBB3_666:                              //  %if.end737
	jal x0, .LBB3_551
.LBB3_495:                              //  %while.end1298.loopexit
                                        //    in Loop: Header=BB3_4 Depth=1
	add x23, x26, 1
	sub x22, x23, x25
	sb x0, 0 ( x23 )
	...
	bltu x0, x10, .LBB3_532
	jal x0, .LBB3_535
.LBB3_512:                              //  %if.end14.if.end34_crit_edge.i2522
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 0 ( x18 )
.LBB3_513:                              //  %if.end34.i2539
                                        //    in Loop: Header=BB3_4 Depth=1
	sw x10, 56 ( x18 )
	add x10, x0, 3
	sw x10, 52 ( x18 )
...
.LBB3_515:                              //  %if.end1424
	...
	lw x24, -404 ( fp )             //  4-byte Folded Reload
	lw x25, -400 ( fp )             //  4-byte Folded Reload
	beq x23, x15, .LBB3_551
.LBB3_516:                              //  %if.end1430
                                        //    in Loop: Header=BB3_4 Depth=1
	and x10, x26, 16
	bltu x0, x10, .LBB3_543
.LBB3_517:                              //  %if.then1434
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x13, -384 ( fp )             //  4-byte Folded Reload
...
.LBB3_518:                              //  %if.else1441
                                        //    in Loop: Header=BB3_4 Depth=1
	and x11, x26, 8
	add x15, fp, -368
	bltu x0, x11, .LBB3_525
.LBB3_519:                              //  %if.else1447
                                        //    in Loop: Header=BB3_4 Depth=1
	and x11, x26, 4
	bltu x0, x11, .LBB3_526
.LBB3_520:                              //  %if.else1453
                                        //    in Loop: Header=BB3_4 Depth=1
	and x11, x26, 1
	bltu x0, x11, .LBB3_522
.LBB3_521:                              //  %if.else1458
                                        //    in Loop: Header=BB3_4 Depth=1
	and x11, x26, 2
	bltu x0, x11, .LBB3_527
.LBB3_522:                              //  %if.else1472
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x11, -68 ( fp )
	jal x0, .LBB3_523
.LBB3_524:                              //  %if.then1439
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x11, -68 ( fp )
	add x15, fp, -368
.LBB3_523:                              //  %if.end1478
...
.LBB3_526:                              //  %if.then1450
	...
	sh x10, 0 ( x11 )
	jal x0, .LBB3_542
.LBB3_527:                              //  %if.then1461
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x11, -392 ( fp )             //  4-byte Folded Reload
	lui x10, %hi( _strtoul_r )
	add x10, x10, %lo( _strtoul_r )
	beq x11, x10, .LBB3_540
.LBB3_528:                              //  %if.else1467
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x13, -384 ( fp )             //  4-byte Folded Reload
	add x11, fp, -368
	mv x12, x0
...
.LBB3_497:                              //  %if.then894
	...
	or x10, x10, 32
	sh x10, 12 ( x18 )
	beq x25, x23, .LBB3_546
.LBB3_498:                              //  %while.end900
                                        //    in Loop: Header=BB3_4 Depth=1
	sub x22, x25, x23
	beq x0, x22, .LBB3_563
.LBB3_499:                              //  %if.end907
	...
	bltu x0, x10, .LBB3_532
	jal x0, .LBB3_535
.LBB3_500:                              //  %for.end1413.loopexit.split.loop.exit
                                        //    in Loop: Header=BB3_4 Depth=1
	sw x12, -384 ( fp )             //  4-byte Folded Spill
	add x10, x24, x15
	and x11, x26, 256
	beq x0, x11, .LBB3_230
	jal x0, .LBB3_501
.LBB3_529:                              //  %__ssrefill_r.exit2481.loopexit
                                        //    in Loop: Header=BB3_4 Depth=1
	add x23, x26, 1
.LBB3_530:                              //  %__ssrefill_r.exit2481
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, 16 ( x18 )
	sw x0, 4 ( x18 )
	sw x10, 0 ( x18 )
...
.LBB3_532:                              //  %while.end1298
                                        //    in Loop: Header=BB3_4 Depth=1
	add x11, x22, 1
	bgeu x11, x24, .LBB3_535
.LBB3_533:                              //  %if.then1308
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x10, -408 ( fp )             //  4-byte Folded Reload
	lw x10, 0 ( x10 )
	jal realloc
	beq x0, x10, .LBB3_535
.LBB3_534:                              //  %if.then1313
                                        //    in Loop: Header=BB3_4 Depth=1
	lw x11, -408 ( fp )             //  4-byte Folded Reload
	sw x10, 0 ( x11 )
.LBB3_535:                              //  %cleanup1321
                                        //    in Loop: Header=BB3_4 Depth=1
	add x27, x27, x22
.LBB3_536:                              //  %if.end1326
                                        //    in Loop: Header=BB3_4 Depth=1
...
.LBB3_673:                              //  %cleanup1487.thread
                                        //    in Loop: Header=BB3_4 Depth=1
	jal x0, .LBB3_4
.LBB3_672:                              //  %cleanup1487.thread
	jal x0, .LBB3_551
.LBB3_544:
	mv x25, x0
	jal x0, .LBB3_558
.LBB3_545:                              //  %__ssrefill_r.exit2265
	lw x10, 16 ( x18 )
	sw x10, 0 ( x18 )
	lh x10, 12 ( x18 )
	or x10, x10, 32
	...
	sw x0, 4 ( x18 )
	lw x25, -400 ( fp )             //  4-byte Folded Reload
	bltu x0, x25, .LBB3_549
	jal x0, .LBB3_550
.LBB3_546:                              //  %cleanup402.thread2578
	lw x24, -404 ( fp )             //  4-byte Folded Reload
	lw x25, -400 ( fp )             //  4-byte Folded Reload
	bltu x0, x25, .LBB3_549
	jal x0, .LBB3_550
.LBB3_547:                              //  %__ssrefill_r.exit2247
	lw x10, 16 ( x18 )
	sw x0, 4 ( x18 )
	sw x10, 0 ( x18 )
	lh x10, 12 ( x18 )
	...
	bltu x0, x25, .LBB3_549
	jal x0, .LBB3_550
.LBB3_548:                              //  %cleanup740.thread2622
	lw x24, -404 ( fp )             //  4-byte Folded Reload
	beq x0, x25, .LBB3_550
.LBB3_549:                              //  %land.lhs.true1492
	lbu x10, 12 ( x18 )
	mv x11, x0
	and x10, x10, 64
	beq x10, x11, .LBB3_551
.LBB3_550:                              //  %land.lhs.true1492
	add x25, x0, -1
.LBB3_551:                              //  %do.body1497
	beq x0, x24, .LBB3_558
.LBB3_552:                              //  %if.then1499
	xor x10, x25, -1
	bltu x0, x10, .LBB3_556
.LBB3_553:                              //  %for.cond1503.preheader
	lhu x10, 6 ( x24 )
	add x25, x0, -1
	beq x0, x10, .LBB3_556
.LBB3_554:                              //  %for.body1508.lr.ph
	mv x9, x0
	mv x18, x9
.LBB3_555:                              //  %for.body1508
                                        //  =>This Inner Loop Header: Depth=1
	lw x10, 0 ( x24 )
	add x10, x9, x10
	lw x10, 0 ( x10 )
	...
	sw x0, 0 ( x10 )
	lhu x10, 6 ( x24 )
	bltu x18, x10, .LBB3_555
.LBB3_556:                              //  %if.end1516
	lw x10, 0 ( x24 )
	beq x0, x10, .LBB3_558
.LBB3_557:                              //  %if.then1519
	jal free
.LBB3_558:                              //  %cleanup1525
	mv x10, x25
...
.LBB3_565:
	mv x23, x25
.LBB3_566:                              //  %cleanup740.thread
	lw x25, -404 ( fp )             //  4-byte Folded Reload
.LBB3_567:                              //  %cleanup740.thread
	mv x24, x25
	mv x25, x23
	bltu x0, x24, .LBB3_552
	jal x0, .LBB3_558
...
.LBB3_573:
	...
	lhu x10, 6 ( x24 )
	add x25, x0, -1
	bltu x0, x10, .LBB3_554
	jal x0, .LBB3_556
.LBB3_571:
	lw x23, -400 ( fp )             //  4-byte Folded Reload
	lw x24, -404 ( fp )             //  4-byte Folded Reload
	mv x25, x23
	bltu x0, x24, .LBB3_552
	jal x0, .LBB3_558
