# 1 "/tools/toolchain/newlib/newlib/libc/string/strxfrm_l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strxfrm_l.c" 2
# 49 "/tools/toolchain/newlib/newlib/libc/string/strxfrm_l.c"
...
# 50 "/tools/toolchain/newlib/newlib/libc/string/strxfrm_l.c" 2
