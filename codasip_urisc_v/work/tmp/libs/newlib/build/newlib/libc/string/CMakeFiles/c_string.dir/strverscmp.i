# 1 "/tools/toolchain/newlib/newlib/libc/string/strverscmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strverscmp.c" 2
# 60 "/tools/toolchain/newlib/newlib/libc/string/strverscmp.c"
...
# 61 "/tools/toolchain/newlib/newlib/libc/string/strverscmp.c" 2
...
# 62 "/tools/toolchain/newlib/newlib/libc/string/strverscmp.c" 2
...
int strverscmp(const char *l0, const char *r0)
{
 ...
 for (dp=i=0; l[i]==r[i]; i++) {
  int c = l[i];
  if (!c) return 0;
  if (!((((_ctype_)+sizeof(""[c]))[(int)(c)])&04)) dp=i+1, z=1;
  else if (c!='0') z=0;
 }
