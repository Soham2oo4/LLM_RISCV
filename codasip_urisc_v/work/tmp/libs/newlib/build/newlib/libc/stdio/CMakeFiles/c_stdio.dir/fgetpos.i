# 1 "/tools/toolchain/newlib/newlib/libc/stdio/fgetpos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/fgetpos.c" 2
# 63 "/tools/toolchain/newlib/newlib/libc/stdio/fgetpos.c"
...
# 64 "/tools/toolchain/newlib/newlib/libc/stdio/fgetpos.c" 2
...
# 65 "/tools/toolchain/newlib/newlib/libc/stdio/fgetpos.c" 2
...
# 66 "/tools/toolchain/newlib/newlib/libc/stdio/fgetpos.c" 2

int
_fgetpos_r (struct _reent * ptr,
       FILE *restrict fp,
       _fpos_t *restrict pos)
{
  *pos = _ftell_r (ptr, fp);
