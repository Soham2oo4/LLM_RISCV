# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallocr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallocr.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallocr.c"
...
static void* sbrk_aligned(struct _reent *reent_ptr, malloc_size_t s)
{
    ...
    align_p = (char*)((((uintptr_t)p) + ((sizeof(void*))) - (intptr_t)1) & ~(((sizeof(void*))) - (intptr_t)1));
    if (align_p != p)
    {
...
void * _malloc_r(struct _reent *reent_ptr, malloc_size_t s)
{
    ...
    alloc_size = (((s) + ((sizeof(void*))) - (size_t)1) & ~(((sizeof(void*))) - (size_t)1));
    ...
    align_ptr = (char *)((((uintptr_t)ptr) + ((8U)) - (intptr_t)1) & ~(((8U)) - (intptr_t)1));
    offset = align_ptr - ptr;

    if (offset)
    {
# 328 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/../nano-mallocr.c"
...
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallocr.c" 2
