# 1 "/tools/toolchain/newlib/newlib/libc/string/swab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/swab.c" 2
# 18 "/tools/toolchain/newlib/newlib/libc/string/swab.c"
...
# 19 "/tools/toolchain/newlib/newlib/libc/string/swab.c" 2
