# 1 "/tools/toolchain/newlib/newlib/libc/string/wcscat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/wcscat.c" 2
# 60 "/tools/toolchain/newlib/newlib/libc/string/wcscat.c"
...
# 61 "/tools/toolchain/newlib/newlib/libc/string/wcscat.c" 2
...
# 62 "/tools/toolchain/newlib/newlib/libc/string/wcscat.c" 2

wchar_t *
wcscat (wchar_t *restrict s1,
