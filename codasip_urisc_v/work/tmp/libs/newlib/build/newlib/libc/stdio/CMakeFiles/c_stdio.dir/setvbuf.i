# 1 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c" 2
# 81 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c"
...
# 82 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c" 2
...
# 83 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c" 2
...
_Noreturn void
 quick_exit(int);
# 84 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c" 2
...
# 85 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c" 2
       ...
       register size_t size)
{
  ...
  if (mode != 2)
    if ((mode != 0 && mode != 1) || (int)(long) size < 0)
      return ((-1));
# 119 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c"
...
nbf:
  ...
  if (!reent->__sdidinit)
    __sinit(reent);
# 187 "/tools/toolchain/newlib/newlib/libc/stdio/setvbuf.c"
  if (size != iosize)
     fp->_flags |= 0x0800;
