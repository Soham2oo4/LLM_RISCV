# 1 "/tools/toolchain/newlib/newlib/libc/string/gnu_basename.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/gnu_basename.c" 2
# 14 "/tools/toolchain/newlib/newlib/libc/string/gnu_basename.c"
...
# 15 "/tools/toolchain/newlib/newlib/libc/string/gnu_basename.c" 2
