# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
# 32 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c"
...
# 33 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
...
# 34 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
...
# 35 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
...
# 36 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
...
_Noreturn void
 quick_exit(int);
# 37 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h" 2
...
# 37 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
...
# 38 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c" 2
...
# 70 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c"
static void
rshift (_Bigint *b,
 int k)
{
...
# 130 "/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c"
 {
  if (b->_wds >= b->_maxwds) {
   b1 = ({ void *__ptr = _Balloc(ptr, b->_k+1); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c", 132, (char *)0, "Balloc succeeded"); __ptr; });
 ...
 *sp = (char*)s;
 ...
 for(k = 0; n > 7; n >>= 1)
  k++;
 b = ({ void *__ptr = _Balloc(ptr, k); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/gdtoa-gethex.c", 222, (char *)0, "Balloc succeeded"); __ptr; });
 x = b->_x;
 n = 0;
 L = 0;
 while(s1 > s0) {
