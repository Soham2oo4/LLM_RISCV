# 1 "/tools/toolchain/newlib/newlib/libc/string/wcsstr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/wcsstr.c" 2
# 59 "/tools/toolchain/newlib/newlib/libc/string/wcsstr.c"
...
# 60 "/tools/toolchain/newlib/newlib/libc/string/wcsstr.c" 2
...
# 61 "/tools/toolchain/newlib/newlib/libc/string/wcsstr.c" 2
...
# 62 "/tools/toolchain/newlib/newlib/libc/string/wcsstr.c" 2

wchar_t *
wcsstr (const wchar_t *restrict big,
 const wchar_t *restrict little)
{
  const wchar_t *p;
  const wchar_t *q;
  const wchar_t *r;
