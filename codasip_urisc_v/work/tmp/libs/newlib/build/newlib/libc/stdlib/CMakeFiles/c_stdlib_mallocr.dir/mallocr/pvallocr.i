# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/pvallocr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/pvallocr.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/pvallocr.c"
...
# 659 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/../nano-mallocr.c"
void * _pvalloc_r(struct _reent *reent_ptr, size_t s)
{

    if (s > 4294967295U - (0x1000))
    {
 reent_ptr->_errno = 12;
 return ((void*)0);
    }
    return _valloc_r(reent_ptr, (((s) + ((0x1000)) - (size_t)1) & ~(((0x1000)) - (size_t)1)));
}
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/pvallocr.c" 2
