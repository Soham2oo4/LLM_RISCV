# 1 "/tools/toolchain/newlib/newlib/libc/time/gmtime_r.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/time/gmtime_r.c" 2
# 20 "/tools/toolchain/newlib/newlib/libc/time/gmtime_r.c"
...
# 3 "/tools/toolchain/newlib/newlib/libc/time/./local.h" 2
...
# 21 "/tools/toolchain/newlib/newlib/libc/time/gmtime_r.c" 2
# 48 "/tools/toolchain/newlib/newlib/libc/time/gmtime_r.c"
struct tm *
gmtime_r (const time_t *restrict tim_p,
