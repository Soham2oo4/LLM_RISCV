# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c" 2
# 29 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
...
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c" 2
...
_Noreturn void
 quick_exit(int);
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c" 2
...
# 32 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c" 2
...
# 33 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c" 2
...
# 34 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c" 2
...
quorem (_Bigint * b, _Bigint * S)
{
      ...
      do
 {
   ...
   borrow = z >> 16;
                          ;
   (*(bx)++ = ((z) << 16) | ((y) & 0xffff));
# 89 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
 }
      while (sx <= sxe);
      if (!*bxe)
 {
      ...
      do
 {
   ...
   borrow = z >> 16;
                          ;
   (*(bx)++ = ((z) << 16) | ((y) & 0xffff));
# 128 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
 }
      while (sx <= sxe);
      bx = b->_x;
      bxe = bx + n;
...
# 177 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
char *
_dtoa_r (struct _reent *ptr,
 ...
 char **rve)
{
# 220 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
...
# 324 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
      i -= 1023;
 ...
 i = 1;
  ...
  for (((ptr)->_result_k) = 0; sizeof (_Bigint) - sizeof (__ULong) + j <= i;
       j <<= 1)
    ((ptr)->_result_k)++;
  ((ptr)->_result) = ({ void *__ptr = _Balloc(ptr, ((ptr)->_result_k)); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c", 426, (char *)0, "Balloc succeeded"); __ptr; });
      ...
      for (i = 1;; i++)
 {
   L = d.d / ds;
   d.d -= L * ds;
# 568 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
   *s++ = '0' + (int) L;
   if (i == ilim)
     {
       d.d += d.d;
...
# 685 "/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c"
 ...
 mhi = __lshift (ptr, mhi, m2);
      ...
      if (spec_case)
 {
   mhi = ({ void *__ptr = _Balloc(ptr, mhi->_k); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/dtoa.c", 746, (char *)0, "Balloc succeeded"); __ptr; });
