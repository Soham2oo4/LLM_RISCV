# 1 "/tools/toolchain/newlib/newlib/libc/string/strcoll_l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strcoll_l.c" 2
# 40 "/tools/toolchain/newlib/newlib/libc/string/strcoll_l.c"
...
# 41 "/tools/toolchain/newlib/newlib/libc/string/strcoll_l.c" 2
