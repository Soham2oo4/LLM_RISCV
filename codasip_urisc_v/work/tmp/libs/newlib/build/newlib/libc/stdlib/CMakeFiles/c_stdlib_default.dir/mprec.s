...
.LBB2_1:                                //  %do.body
	...
	srl x16, x15, 16&31
	and x15, x13, x15
	hackaton_custom_instr_c x15, x12, x15
	add x15, fp, x15
	srl x17, x15, 16&31
	hackaton_custom_instr_c x16, x12, x16
	add x16, x16, x17
	and x15, x13, x15
	sll x17, x16, 16&31
	or x15, x15, x17
...
.LBB7_16:                               //  %do.body
	...
	srl x4, x3, 16&31
	and x3, x17, x3
	hackaton_custom_instr_c x29, x6, x29
	add x28, x28, x3
	add x28, x29, x28
	hackaton_custom_instr_c x30, x6, x30
	srl x29, x28, 16&31
	add x30, x4, x30
	add x29, x29, x30
	and x28, x17, x28
...
.LBB7_20:                               //  %do.body42
	...
	add x29, x31, x29
	lhu x31, 0 ( x28 )
	hackaton_custom_instr_c x31, x6, x31
	add x31, x31, x29
	and x29, x17, x30
	sll x30, x31, 16&31
	or x29, x29, x30
	...
	srl x31, x31, 16&31
	add x28, x28, 4
	hackaton_custom_instr_c x30, x6, x29
	lw x29, 4 ( x7 )
	add x7, x7, 4
	and x3, x17, x29
	add x30, x3, x30
