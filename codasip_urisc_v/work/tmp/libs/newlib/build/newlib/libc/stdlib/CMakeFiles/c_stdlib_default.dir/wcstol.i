# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
# 119 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c"
...
# 120 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
...
# 121 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
...
# 122 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
...
# 123 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
...
# 124 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
...
# 125 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
...
int __messages_load_locale (struct __locale_t *, const char *, void *,
       const char *);
# 126 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c" 2
    ...
    int base, locale_t loc)
{
 ...
 if (base == 0)
  base = c == L'0' ? 8 : 10;
# 179 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstol.c"
...
long
wcstol_l (const wchar_t *restrict s, wchar_t **restrict ptr, int base,
   locale_t loc)
{
 return _wcstol_l (_impure_ptr, s, ptr, base, loc);
}

long
wcstol (const wchar_t *restrict s,
 wchar_t **restrict ptr,
 int base)
{
 return _wcstol_l (_impure_ptr, s, ptr, base, __get_current_locale ());
}
