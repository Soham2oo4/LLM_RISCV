# 1 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c" 2
# 32 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c"
...
# 33 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c" 2
...
# 34 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c" 2
# 54 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c"
int
strcmp (const char *s1,
 const char *s2)
{
# 67 "/tools/toolchain/newlib/newlib/libc/string/strcmp.c"
  unsigned long *a1;
  unsigned long *a2;
