# 1 "/tools/toolchain/newlib/newlib/libc/string/bcmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/bcmp.c" 2
# 31 "/tools/toolchain/newlib/newlib/libc/string/bcmp.c"
...
# 32 "/tools/toolchain/newlib/newlib/libc/string/bcmp.c" 2
