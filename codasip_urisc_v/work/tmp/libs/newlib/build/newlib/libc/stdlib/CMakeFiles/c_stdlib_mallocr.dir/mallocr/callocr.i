# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/callocr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/callocr.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/callocr.c"
...
# 448 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/../nano-mallocr.c"
void * _calloc_r(struct _reent *reent_ptr, malloc_size_t n, malloc_size_t elem)
{
    ...
    mem = _malloc_r(reent_ptr, bytes);
    if (mem != ((void*)0)) memset(mem, 0, bytes);
    return mem;
}
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/callocr.c" 2
