...
.LBB0_5:                                //  %entry
	...
	mv x18, x10
	lui x10, %hi( -146097 )
	add x10, x10, %lo( -146097 )
	hackaton_custom_instr_c x10, x10, x18
	add x19, x26, x10
	add x22, x0, 1460
	mv x10, x19
	mv x11, x22
	...
	mv x19, x10
	add x10, x0, -365
	hackaton_custom_instr_c x10, x10, x19
	add x27, x10, x22
	add x10, x0, 5
	hackaton_custom_instr_c x10, x10, x27
	add x23, x10, 2
	add x10, x0, 1530
	bltu x23, x10, .LBB0_6
.LBB0_7:                                //  %entry
...
.LBB0_10:                               //  %entry
	...
	jal __divsi3
	mv x20, x10
	hackaton_custom_instr_c x10, x24, x20
	sub x21, x21, x10
	add x24, x0, 60
	mv x10, x21
	mv x11, x24
...
.LBB0_11:
	add x10, x10, 7
.LBB0_12:                               //  %entry
	hackaton_custom_instr_c x11, x24, x25
	sub x11, x21, x11
	add x9, x0, 153
	sw x10, 24 ( fp )
	sw x11, 0 ( fp )
	...
	sub x10, x27, x10
	add x9, x10, 1
	hackaton_custom_instr_c x18, x11, x18
	sltiu x21, x20, 2
	sltiu x10, x27, 306
	bltu x0, x10, .LBB0_14
.LBB0_13:                               //  %cond.true53
