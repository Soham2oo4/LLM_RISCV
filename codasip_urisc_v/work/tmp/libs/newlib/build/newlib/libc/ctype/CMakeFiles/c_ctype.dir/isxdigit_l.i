# 1 "/tools/toolchain/newlib/newlib/libc/ctype/isxdigit_l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/ctype/isxdigit_l.c" 2
...
# 2 "/tools/toolchain/newlib/newlib/libc/ctype/isxdigit_l.c" 2
...
# 3 "/tools/toolchain/newlib/newlib/libc/ctype/isxdigit_l.c" 2
...
{
  return __locale_ctype_ptr_l (locale)[c+1] & ((0100)|(04));
}
