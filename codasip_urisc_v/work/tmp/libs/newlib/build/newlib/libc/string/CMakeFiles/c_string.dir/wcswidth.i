# 1 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c" 2
# 32 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c"
...
# 33 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c" 2
...
# 34 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c" 2
...
# 35 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c" 2
...

{
  ...
  do {
    wint_t wi = *pwcs;
# 61 "/tools/toolchain/newlib/newlib/libc/string/wcswidth.c"
    if ((w = __wcwidth (wi)) < 0)
      return -1;
    len += w;
  } while (*pwcs++ && --n > 0);
