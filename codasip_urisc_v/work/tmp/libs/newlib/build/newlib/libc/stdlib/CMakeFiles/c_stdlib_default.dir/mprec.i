# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c" 2
# 83 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
...
# 84 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c" 2
...
# 19 "/tools/toolchain/newlib/newlib/libc/include/stdlib.h" 2 3
...
_Noreturn void
 quick_exit(int);
# 85 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c" 2
...
# 86 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c" 2
...
# 87 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c" 2
...
# 88 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c" 2
  ...
  if (a)
    {
      if (wds >= b->_maxwds)
 {
   b1 = ({ void *__ptr = _Balloc(ptr, b->_k + 1); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 181, (char *)0, "Balloc succeeded"); __ptr; });
 ...
 __ULong y9)
{
  ...
  b = ({ void *__ptr = _Balloc(ptr, k); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 206, (char *)0, "Balloc succeeded"); __ptr; });
  b->_x[0] = y9;
  b->_wds = 1;
...
__i2b (struct _reent * ptr, int i)
{
  ...
  b = ({ void *__ptr = _Balloc(ptr, 1); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 320, (char *)0, "Balloc succeeded"); __ptr; });
  b->_x[0] = i;
  b->_wds = 1;
  return b;
}
...
__multiply (struct _reent * ptr, _Bigint * a, _Bigint * b)
{
  ...
  if (wc > a->_maxwds)
    k++;
  c = ({ void *__ptr = _Balloc(ptr, k); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 349, (char *)0, "Balloc succeeded"); __ptr; });
...
# 413 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
...
__lshift (struct _reent * ptr, _Bigint * b, int k)
{
  ...
  for (i = b->_maxwds; n1 > i; i <<= 1)
    k1++;
  b1 = ({ void *__ptr = _Balloc(ptr, k1); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 473, (char *)0, "Balloc succeeded"); __ptr; });
  x1 = b1->_x;
  for (i = 0; i < n; i++)
    *x1++ = 0;
  x = b->_x;
...
# 508 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
  else
    do
      *x1++ = *x++;
    while (x < xe);
 ...
 _Bigint * a, _Bigint * b)
{
  ...
  if (!i)
    {
      c = ({ void *__ptr = _Balloc(ptr, 0); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 562, (char *)0, "Balloc succeeded"); __ptr; });
      c->_wds = 1;
      c->_x[0] = 0;
      return c;
    }
  if (i < 0)
    ...
    i = 0;
  c = ({ void *__ptr = _Balloc(ptr, a->_k); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 576, (char *)0, "Balloc succeeded"); __ptr; });
  c->_sign = i;
  wa = a->_wds;
  xa = a->_x;
  xae = xa + wa;
...
# 625 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
  while (!*--xc)
    wa--;
  c->_wds = wa;
  return c;
...
# 742 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
ret_d:
...

{
  ...
  b = ({ void *__ptr = _Balloc(ptr, 1); if (__ptr == ((void*)0)) __assert_func("/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c", 778, (char *)0, "Balloc succeeded"); __ptr; });
...
# 879 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
  if (de)
    {
...
# 935 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
  if (k > 0)
...
# 971 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
double
 ...
 _Bigint *b)
{
 ...
 while(x < xe)
  *c++ = *x++;
# 1009 "/tools/toolchain/newlib/newlib/libc/stdlib/mprec.c"
 while(c < ce)
  *c++ = 0;
}
