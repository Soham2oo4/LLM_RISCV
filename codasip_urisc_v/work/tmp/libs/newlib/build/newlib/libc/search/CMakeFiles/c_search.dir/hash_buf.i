# 1 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
# 33 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
...
# 34 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
# 57 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
# 1 "/home/project/codasip_urisc_v/work/ia/sdk/lib/clang/9.0.1/include/stddef.h" 1 3
# 58 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
...
# 59 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
...
_Noreturn void
 quick_exit(int);
# 60 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
...
# 66 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
...
# 67 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
...
# 68 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2
...
# 69 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c" 2

static BUFHEAD *newbuf(HTAB *, __uint32_t, BUFHEAD *);
# 109 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
extern BUFHEAD *
 ...
 if (hashp->nbufs || (bp->flags & 0x0008)) {
  ...
  if ((bp->addr != 0) || (bp->flags & 0x0004)) {
   ...
   if ((bp->flags & 0x0001) && __put_page(hashp, bp->page,
    ...
    return (((void*)0));
# 225 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
   if (((bp->flags) & 0x0004)) {
 ...
 bp->ovfl = ((void*)0);
 if (prev_bp) {
# 286 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
  prev_bp->ovfl = bp;
  bp->flags = 0;
 } else
  bp->flags = 0x0004;
 ...
 int nbytes;
{
 ...
 bfp->next = bfp;
 bfp->prev = bfp;
# 317 "/tools/toolchain/newlib/newlib/libc/search/hash_buf.c"
}
