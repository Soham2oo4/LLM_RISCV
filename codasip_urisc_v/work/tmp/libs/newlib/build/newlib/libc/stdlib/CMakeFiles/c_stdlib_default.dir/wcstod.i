# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
# 134 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c"
...
# 135 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 136 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
_Noreturn void
 quick_exit(int);
# 137 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 138 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 139 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 140 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 141 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 142 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
...
# 143 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c" 2
    ...
    locale_t loc)
{
        ...
        while (iswspace_l(*nptr, loc))
                nptr++;
# 168 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c"
        wcp = nptr;
        mbs = initial;
        if ((len = _wcsnrtombs_l(ptr, ((void*)0), &wcp, (size_t) -1, 0, &mbs, loc))
     == (size_t) -1) {
                if (endptr != ((void*)0))
                        *endptr = (wchar_t *)nptr;
                return (0.0);
        }
        if ((buf = _malloc_r(ptr, len + 1)) == ((void*)0))
                return (0.0);
        mbs = initial;
...
# 202 "/tools/toolchain/newlib/newlib/libc/stdlib/wcstod.c"
...
wcstod_l (const wchar_t *restrict nptr, wchar_t **restrict endptr,
   locale_t loc)
{
  return _wcstod_l (_impure_ptr, nptr, endptr, loc);
}

double
wcstod (const wchar_t *restrict nptr, wchar_t **restrict endptr)
{
  return _wcstod_l (_impure_ptr, nptr, endptr, __get_current_locale ());
}
