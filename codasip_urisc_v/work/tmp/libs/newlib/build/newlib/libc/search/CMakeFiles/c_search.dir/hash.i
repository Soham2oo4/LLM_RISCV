# 1 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
# 33 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
...
# 34 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 39 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 12 "/tools/toolchain/newlib/newlib/libc/include/time.h" 3
...
# 13 "/tools/toolchain/newlib/newlib/libc/include/time.h" 2 3
...
# 41 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2

# 1 "/tools/toolchain/newlib/newlib/libc/include/reent.h" 1 3
# 98 "/tools/toolchain/newlib/newlib/libc/include/reent.h" 3
# 1 "/home/project/codasip_urisc_v/work/ia/sdk/lib/clang/9.0.1/include/stddef.h" 1 3
...
# 43 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 44 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 45 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 46 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
_Noreturn void
 quick_exit(int);
# 47 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 48 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 49 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 55 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 56 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 57 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 58 "/tools/toolchain/newlib/newlib/libc/search/hash.c" 2
...
# 109 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
extern DB *
 ...
 const HASHINFO *info)
{
 ...
 new_table = 0;
 if (!file || (flags & 0x0400) ||



     (_stat_r(_impure_ptr, file, &statbuf) && ((*__errno()) == 2))) {
 ...
 if (file) {
  if ((hashp->fp = open(file, flags, mode)) == -1)
   { save_errno = (*__errno()); goto error0; };
  ...
  if ((flags & 0x0200) &&
       ...
       _fstat_r(_impure_ptr, hashp->fp, &statbuf) == 0 && statbuf.st_size == 0)
 ...
 if (new_table) {
  if (!(hashp = init_hash(hashp, file, (HASHINFO *)info)))
   { save_errno = (*__errno()); goto error1; };
 } else {
  ...
  if (hdrsize != sizeof(HASHHDR))
   { save_errno = 79; goto error1; };

  if (hashp->hdr.magic != 0x061561L)
   { save_errno = 79; goto error1; };
 ...
 dbp->sync = hash_sync;
 dbp->type = DB_HASH;
# 272 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
 return (dbp);
 ...
 const HASHINFO *info;
{
 ...
 if (file != ((void*)0)) {
  ...
  if (_stat_r(_impure_ptr, file, &statbuf))
 ...
 int nelem;
{
 ...
 hashp->hdr.hdrpages = ((((sizeof(HASHHDR)) > (512) ? (sizeof(HASHHDR)) : (512)) - 1) >>
     hashp->hdr.bshift) + 1;
 ...
 HTAB *hashp;
{
 ...
 save_errno = 0;
# 465 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
...
# 576 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
static int
...
# 858 "/tools/toolchain/newlib/newlib/libc/search/hash.c"
extern int
 ...
 HTAB *hashp;
{
 ...
 if (new_segnum >= hashp->nsegs) {
  ...
  if ((hashp->dir[new_segnum] =
      (SEGMENT)calloc(hashp->hdr.ssize, sizeof(SEGMENT))) == ((void*)0))
   return (-1);
  hashp->exsegs++;
  hashp->nsegs++;
 }
 ...
 int nsegs;
{
 ...
 if ((hashp->dir =
     (SEGMENT *)calloc(hashp->hdr.dsize, sizeof(SEGMENT *))) == ((void*)0)) {
  save_errno = (*__errno());
  (void)hdestroy(hashp);
  (*__errno()) = save_errno;
  return (-1);
 ...
 if ((store =
     (SEGMENT)calloc(nsegs << hashp->hdr.sshift, sizeof(SEGMENT))) == ((void*)0)) {
  save_errno = (*__errno());
  (void)hdestroy(hashp);
  (*__errno()) = save_errno;
  return (-1);
