# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/svfprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/svfprintf.c" 2
# 27 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/svfprintf.c"
...
# 358 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
int __ssprint_r (struct _reent *, FILE *, register struct __suio *);
# 504 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
extern char *_dtoa_r (struct _reent *, double, int,
         int, int *, int *, char **);
# 526 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
...
# 652 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
int
...
# 869 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
...
# 1283 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
   if (ch == 'a' || ch == 'A') {
    ox[0] = '0';
    ox[1] = ch == 'a' ? 'x' : 'X';
    flags |= 0x002;
   ...
   if (ch >= 'f') {
    if ((_double_.fp) == 0) {
     ...
     if (flags & 0x400) {
      ...
      { iovp->iov_base = (thousands_sep); iovp->iov_len = (thsnd_len); uio.uio_resid += (thsnd_len); iovp++; if (++uio.uio_iovcnt >= 8) { if (__ssprint_r(data, fp, &uio)) goto error; iovp = iov; } };
...
# 1797 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
static char *
    ...
    char *sign, int *decpt, int ch, int *length, char *buf)
{
  ...
  *sign = '\000';
# 1828 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/../vfprintf.c"
 if (ch == 'a' || ch == 'A') {
...
# 28 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf/svfprintf.c" 2
