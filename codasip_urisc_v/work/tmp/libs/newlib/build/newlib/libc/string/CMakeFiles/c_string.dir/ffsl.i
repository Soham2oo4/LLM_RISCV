# 1 "/tools/toolchain/newlib/newlib/libc/string/ffsl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/ffsl.c" 2
# 27 "/tools/toolchain/newlib/newlib/libc/string/ffsl.c"
...
# 28 "/tools/toolchain/newlib/newlib/libc/string/ffsl.c" 2
