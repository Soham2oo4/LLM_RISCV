# 1 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c" 2
# 53 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c"
# 1 "/tools/toolchain/newlib/newlib/libc/machine/codasip/newlib.h" 1 3
# 54 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c" 2
...
# 55 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c" 2
...
_Noreturn void
 quick_exit(int);
# 56 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c" 2
...
int __messages_load_locale (struct __locale_t *, const char *, void *,
       const char *);
# 57 "/tools/toolchain/newlib/newlib/libc/locale/uselocale.c" 2
...
_uselocale_r (struct _reent *p, struct __locale_t *newloc)
{
  ...
  if (!current_locale)
    current_locale = ((struct __locale_t *) -1);
...
{
  return _uselocale_r (_impure_ptr, newloc);
}
