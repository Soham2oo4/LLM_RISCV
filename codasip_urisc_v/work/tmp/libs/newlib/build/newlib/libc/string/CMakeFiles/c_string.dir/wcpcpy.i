# 1 "/tools/toolchain/newlib/newlib/libc/string/wcpcpy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/wcpcpy.c" 2
# 25 "/tools/toolchain/newlib/newlib/libc/string/wcpcpy.c"
...
# 26 "/tools/toolchain/newlib/newlib/libc/string/wcpcpy.c" 2
...
# 27 "/tools/toolchain/newlib/newlib/libc/string/wcpcpy.c" 2

wchar_t *
wcpcpy (wchar_t *restrict s1,
