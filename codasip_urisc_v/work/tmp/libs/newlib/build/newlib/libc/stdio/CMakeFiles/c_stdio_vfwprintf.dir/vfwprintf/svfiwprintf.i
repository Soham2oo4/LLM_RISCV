# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf/svfiwprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf/svfiwprintf.c" 2
# 28 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf/svfiwprintf.c"
...
int
_svfiwprintf_r (struct _reent *data,
       FILE * fp,
       const wchar_t *fmt0,
       va_list ap)
{
...
# 29 "/tools/toolchain/newlib/newlib/libc/stdio/vfwprintf/svfiwprintf.c" 2
