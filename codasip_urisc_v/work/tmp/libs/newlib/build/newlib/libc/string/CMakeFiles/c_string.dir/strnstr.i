# 1 "/tools/toolchain/newlib/newlib/libc/string/strnstr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strnstr.c" 2
# 34 "/tools/toolchain/newlib/newlib/libc/string/strnstr.c"
...
# 35 "/tools/toolchain/newlib/newlib/libc/string/strnstr.c" 2
