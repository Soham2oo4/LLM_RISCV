# 1 "/tools/toolchain/newlib/newlib/libc/time/ctime_r.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/time/ctime_r.c" 2
...
# 6 "/tools/toolchain/newlib/newlib/libc/time/ctime_r.c" 2
