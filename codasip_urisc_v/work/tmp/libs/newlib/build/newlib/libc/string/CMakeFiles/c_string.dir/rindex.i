# 1 "/tools/toolchain/newlib/newlib/libc/string/rindex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/rindex.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/string/rindex.c"
...
# 31 "/tools/toolchain/newlib/newlib/libc/string/rindex.c" 2
