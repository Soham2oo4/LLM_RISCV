# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
# 134 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
...
# 135 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
...
# 136 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
...
# 20 "/tools/toolchain/newlib/newlib/libc/include/stdlib.h" 2 3
...
# 31 "/tools/toolchain/newlib/newlib/libc/include/stdlib.h" 2 3
...
_Noreturn void
 quick_exit(int);
# 137 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
...
# 138 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h" 1
# 29 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h"
...
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h" 2
...
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h" 2


# 1 "/tools/toolchain/newlib/newlib/libc/include/assert.h" 1 3
# 39 "/tools/toolchain/newlib/newlib/libc/include/assert.h" 3
void __assert (const char *, int, const char *)
     __attribute__ ((__noreturn__));
void __assert_func (const char *, int, const char *, const char *)
     __attribute__ ((__noreturn__));
# 34 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h" 2
...
# 36 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h" 1
# 34 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h"
...
# 35 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h" 2
...
# 38 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h" 2
...
# 39 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h" 2
# 57 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h"
struct lc_ctype_T
{
  const char *codeset;
...
# 100 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h"
};
...
# 153 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h"
};
...
# 284 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h"
...
# 347 "/tools/toolchain/newlib/newlib/libc/stdlib/./../locale/setlocale.h"
...
int __messages_load_locale (struct __locale_t *, const char *, void *,
       const char *);
# 37 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h" 2
# 69 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h"
union double_union
{
  double d;
  __uint32_t i[2];
};
# 85 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h"
...
# 320 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h"
typedef struct _Bigint _Bigint;
# 361 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h"
struct _reent ;
struct FPI;
...
double _strtod_l (struct _reent *ptr, const char *restrict s00,
      char **restrict se, locale_t loc);
# 397 "/tools/toolchain/newlib/newlib/libc/stdlib/./mprec.h"
...
# 139 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/./gdtoa.h" 1
# 36 "/tools/toolchain/newlib/newlib/libc/stdlib/./gdtoa.h"
 enum {
 STRTOG_Zero = 0,
 STRTOG_Normal = 1,
 STRTOG_Denormal = 2,
...
# 140 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c" 2
# 154 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
...
# 183 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
 static double
sulp (U x,
 int scale)
{
...
double
_strtod_l (struct _reent *ptr, const char *restrict s00, char **restrict se,
    locale_t loc)
{
 ...
 if (*s == '0') {
  ...
  switch(s[1]) {
   ...
   s00 = s + 1;
   {
# 316 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
 ...
 if (nd <= 15
  ...
  if (e > 0) {
   if (e <= 22) {
# 508 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
               (rv.d) *= __mprec_tens[e];
    goto ret;
   ...
   i = 15 - nd;
   if (e <= 22 + i) {
# 524 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
    e -= i;
    (rv.d) *= __mprec_tens[i];
# 538 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
               (rv.d) *= __mprec_tens[e];
 ...
 e1 += nd - k;
# 566 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
 scale = 0;
# 581 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
 if (e1 > 0) {
  if ( (i = e1 & 15) !=0)
   (rv.d) *= __mprec_tens[i];
  if (e1 &= ~15) {
 ...
 ovfl:
    ...
    ptr->_errno = 34;
# 608 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
    (rv.i[1]) = ((__uint32_t)0x7ff00000L);

    (rv.i[0]) = 0;
# 624 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
    if (bd0)
     goto retfree;
    goto ret;
    }
...
# 691 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
    if (!(rv.d)) {
 undfl:
     (rv.d) = 0.;
...
# 713 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
   }
  }
 ...
 for(;;) {
  ...
  if (bd == ((void*)0))
   goto ovfl;
  memcpy((char *)&bd->_sign, (char *)&bd0->_sign, bd0->_wds*sizeof(long) + 2*sizeof(int));
...
# 783 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
  bb2 += j;
  bd2 += j;
  ...
  delta->_sign = 0;
  i = __mcmp(delta, bs);
# 925 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
  if (i < 0) {
 ...
 drop_down:
# 1002 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
    if (scale) {
...
# 1098 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
  ...
  if (y == ((__uint32_t)0x100000L)*(1024 +1023 -1)) {
   ...
   adj = (aadj1.d) * __ulp((rv.d));
   (rv.d) += adj;
# 1185 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
   }
...
# 1233 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
 if (scale) {
...
# 1253 "/tools/toolchain/newlib/newlib/libc/stdlib/strtod.c"
 retfree:
 _Bfree(ptr,bb);
 _Bfree(ptr,bd);
 _Bfree(ptr,bs);
...
double
strtod_l (const char *restrict s00, char **restrict se, locale_t loc)
{
  return _strtod_l (_impure_ptr, s00, se, loc);
}

double
strtod (const char *restrict s00, char **restrict se)
{
  return _strtod_l (_impure_ptr, s00, se, __get_current_locale ());
}

float
strtof_l (const char *restrict s00, char **restrict se, locale_t loc)
{
  double val = _strtod_l (_impure_ptr, s00, se, loc);
  if ((__builtin_isnan (val)))
    return ((sizeof(val) == sizeof(float)) ? __builtin_signbitf(val) : (sizeof(val) == sizeof(double)) ? __builtin_signbit (val) : __builtin_signbitl(val)) ? -nanf ("") : nanf ("");
  float retval = (float) val;

  if ((__builtin_isinf_sign (retval)) && !(__builtin_isinf_sign (val)))
    _impure_ptr->_errno = 34;

  return retval;
}

float
strtof (const char *restrict s00,
 char **restrict se)
{
