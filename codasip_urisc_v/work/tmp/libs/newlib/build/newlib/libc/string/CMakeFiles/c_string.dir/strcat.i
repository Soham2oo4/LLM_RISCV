# 1 "/tools/toolchain/newlib/newlib/libc/string/strcat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strcat.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/string/strcat.c"
...
# 31 "/tools/toolchain/newlib/newlib/libc/string/strcat.c" 2
...
# 32 "/tools/toolchain/newlib/newlib/libc/string/strcat.c" 2
# 56 "/tools/toolchain/newlib/newlib/libc/string/strcat.c"
char *
strcat (char *restrict s1,
 const char *restrict s2)
{
# 70 "/tools/toolchain/newlib/newlib/libc/string/strcat.c"
  char *s = s1;
 ...
 aligned_s1++;
  ...
  while (*s1)
    s1++;
# 93 "/tools/toolchain/newlib/newlib/libc/string/strcat.c"
  strcpy (s1, s2);
