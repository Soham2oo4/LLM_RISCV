# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallstatsr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallstatsr.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallstatsr.c"
...
# 532 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/../nano-mallocr.c"
void _malloc_stats_r(struct _reent *reent_ptr)
{
    _mallinfo_r(reent_ptr);
    fiprintf((_impure_ptr->_stderr), "max system bytes = %10u\n",
             __malloc_current_mallinfo.arena);
    fiprintf((_impure_ptr->_stderr), "system bytes     = %10u\n",
             __malloc_current_mallinfo.arena);
    fiprintf((_impure_ptr->_stderr), "in use bytes     = %10u\n",
             __malloc_current_mallinfo.uordblks);
}
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/mallstatsr.c" 2
