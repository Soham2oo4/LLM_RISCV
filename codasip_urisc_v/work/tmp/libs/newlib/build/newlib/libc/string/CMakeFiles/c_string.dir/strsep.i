# 1 "/tools/toolchain/newlib/newlib/libc/string/strsep.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strsep.c" 2
...
# 8 "/tools/toolchain/newlib/newlib/libc/string/strsep.c" 2
...
# 10 "/tools/toolchain/newlib/newlib/libc/string/strsep.c" 2
