# 1 "/tools/toolchain/newlib/newlib/libc/string/strdup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strdup.c" 2
...
# 4 "/tools/toolchain/newlib/newlib/libc/string/strdup.c" 2
...
_Noreturn void
 quick_exit(int);
# 5 "/tools/toolchain/newlib/newlib/libc/string/strdup.c" 2
...
# 6 "/tools/toolchain/newlib/newlib/libc/string/strdup.c" 2
