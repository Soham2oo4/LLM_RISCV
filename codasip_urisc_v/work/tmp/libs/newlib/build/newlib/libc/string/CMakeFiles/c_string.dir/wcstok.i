# 1 "/tools/toolchain/newlib/newlib/libc/string/wcstok.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/wcstok.c" 2
# 90 "/tools/toolchain/newlib/newlib/libc/string/wcstok.c"
...
# 91 "/tools/toolchain/newlib/newlib/libc/string/wcstok.c" 2
...
# 94 "/tools/toolchain/newlib/newlib/libc/string/wcstok.c" 2



wchar_t *
wcstok (register wchar_t *restrict s,
 register const wchar_t *restrict delim,
...
# 122 "/tools/toolchain/newlib/newlib/libc/string/wcstok.c"
cont:
 c = *s++;
