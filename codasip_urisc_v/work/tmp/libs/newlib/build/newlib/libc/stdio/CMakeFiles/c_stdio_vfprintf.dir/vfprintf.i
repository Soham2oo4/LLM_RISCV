# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
# 121 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
# 1 "/tools/toolchain/newlib/newlib/libc/machine/codasip/newlib.h" 1 3
# 122 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
# 147 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 148 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 149 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 150 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
_Noreturn void
 quick_exit(int);
# 151 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 152 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 153 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 154 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 155 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 158 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 159 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 160 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
...
# 161 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c" 2
# 439 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
int __sprint_r (struct _reent *, FILE *, register struct __suio *);
# 450 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 504 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
extern char *_dtoa_r (struct _reent *, double, int,
         int, int *, int *, char **);
# 526 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
static char *cvt(struct _reent *, double, int, int, char *, int *,
                 int, int *, char *);

static int exponent(char *, int, int);
# 564 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 638 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
       ...
       va_list ap)
{
 ...
 register int flags;
 char *fmt_anchor;
# 674 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
 int ret;
 int width;
 int prec;
 char sign;
...
# 848 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 881 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
 fmt = (char *)fmt0;
 ...
 ret = 0;
# 899 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
 for (;;) {
         cp = fmt;
# 914 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
                while (*fmt != '\0' && *fmt != '%')
                    fmt += 1;
...
reswitch: switch (ch) {
  ...
  case '#':
   ...
   goto rflag;
  case '*':
# 1007 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
  ...
  case '.':
   if ((ch = *fmt++) == '*') {
# 1052 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 1093 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
   width = n;
   goto reswitch;
  ...
  case 'c':
   cp = buf;
# 1177 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
   {
...
# 1283 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
   if (ch == 'a' || ch == 'A') {
    ox[0] = '0';
    ox[1] = ch == 'a' ? 'x' : 'X';
    flags |= 0x002;
   ...
   if (softsign)
    sign = '-';
   break;
# 1385 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
  case 'n':
  ...
  case 'o':
   ...
   goto nosign;
  case 'p':
# 1421 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 1511 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
   if (prec >= 0) {
...
# 1641 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
...
# 1673 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
   ...
   if (ch >= 'f') {
    if ((_double_.fp) == 0) {
     ...
     if (flags & 0x400) {
      ...
      { iovp->iov_base = (thousands_sep); iovp->iov_len = (thsnd_len); uio.uio_resid += (thsnd_len); iovp++; if (++uio.uio_iovcnt >= 8) { if (__sprint_r(data, fp, &uio)) goto error; iovp = iov; } };
      { int n = (convbuf + ndig) - (cp); if (n > (*grouping)) n = (*grouping); if (n > 0) { iovp->iov_base = ((cp)); iovp->iov_len = (n); uio.uio_resid += (n); iovp++; if (++uio.uio_iovcnt >= 8) { if (__sprint_r(data, fp, &uio)) goto error; iovp = iov; } }; { if ((n = ((*grouping) - (n > 0 ? n : 0))) > 0) { while (n > 16) { { iovp->iov_base = ((zeroes)); iovp->iov_len = (16); uio.uio_resid += (16); iovp++; if (++uio.uio_iovcnt >= 8) { if (__sprint_r(data, fp, &uio)) goto error; iovp = iov; } }; n -= 16; } { iovp->iov_base = ((zeroes)); iovp->iov_len = (n); uio.uio_resid += (n); iovp++; if (++uio.uio_iovcnt >= 8) { if (__sprint_r(data, fp, &uio)) goto error; iovp = iov; } }; } }; };
...
# 1797 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
static char *
    ...
    char *sign, int *decpt, int ch, int *length, char *buf)
{
  ...
  *sign = '\000';
# 1828 "/tools/toolchain/newlib/newlib/libc/stdio/vfprintf.c"
 if (ch == 'a' || ch == 'A') {
