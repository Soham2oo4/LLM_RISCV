# 1 "/tools/toolchain/newlib/newlib/libc/string/strcspn.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strcspn.c" 2
# 26 "/tools/toolchain/newlib/newlib/libc/string/strcspn.c"
...
# 27 "/tools/toolchain/newlib/newlib/libc/string/strcspn.c" 2
