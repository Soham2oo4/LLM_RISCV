# 1 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c" 2
# 32 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c"
...
# 33 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c" 2
...
# 34 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c" 2
...
# 35 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c" 2
...
# 36 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c" 2
# 51 "/tools/toolchain/newlib/newlib/libc/signal/psignal.c"
void
psignal (int sig,
       const char *s)
{
  ...
  if (s != ((void*)0) && *s != '\0')
    {
      { const char *p = (s); size_t len = strlen (p); while (len) { ssize_t len1 = write (fileno ((_impure_ptr->_stderr)), p, len); if (len1 < 0) break; len -= len1; p += len1; } };
      { const char *p = (": "); size_t len = strlen (p); while (len) { ssize_t len1 = write (fileno ((_impure_ptr->_stderr)), p, len); if (len1 < 0) break; len -= len1; p += len1; } };
    }
  { const char *p = (strsignal (sig)); size_t len = strlen (p); while (len) { ssize_t len1 = write (fileno ((_impure_ptr->_stderr)), p, len); if (len1 < 0) break; len -= len1; p += len1; } };




  { const char *p = ("\n"); size_t len = strlen (p); while (len) { ssize_t len1 = write (fileno ((_impure_ptr->_stderr)), p, len); if (len1 < 0) break; len -= len1; p += len1; } };
