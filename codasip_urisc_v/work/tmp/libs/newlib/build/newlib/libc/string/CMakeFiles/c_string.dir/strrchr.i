# 1 "/tools/toolchain/newlib/newlib/libc/string/strrchr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strrchr.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/string/strrchr.c"
...
# 31 "/tools/toolchain/newlib/newlib/libc/string/strrchr.c" 2
