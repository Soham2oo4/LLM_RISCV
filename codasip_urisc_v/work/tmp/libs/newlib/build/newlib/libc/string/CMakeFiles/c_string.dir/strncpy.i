# 1 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c" 2
# 34 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c"
...
# 35 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c" 2
...
# 36 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c" 2
# 61 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c"
char *
strncpy (char *restrict dst0,
 const char *restrict src0,
 size_t count)
{
# 83 "/tools/toolchain/newlib/newlib/libc/string/strncpy.c"
  char *dst = dst0;
  const char *src = src0;
  long *aligned_dst;
