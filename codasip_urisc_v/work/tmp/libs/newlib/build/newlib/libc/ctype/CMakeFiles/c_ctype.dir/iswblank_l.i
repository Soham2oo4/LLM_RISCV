# 1 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c" 2
...
# 3 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c" 2
...
# 4 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c" 2
...
# 5 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c" 2
...
# 6 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c" 2
...
# 7 "/tools/toolchain/newlib/newlib/libc/ctype/iswblank_l.c" 2
...
iswblank_l (wint_t c, struct __locale_t *locale)
{
  ...
  return c < 0x100 ? __extension__ ({ __typeof__ (c) __x = (c); ((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&0200) || (int) (__x) == '\t';}) : 0;
