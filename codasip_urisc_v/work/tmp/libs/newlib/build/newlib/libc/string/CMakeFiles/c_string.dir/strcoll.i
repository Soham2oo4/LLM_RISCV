# 1 "/tools/toolchain/newlib/newlib/libc/string/strcoll.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/string/strcoll.c" 2
# 36 "/tools/toolchain/newlib/newlib/libc/string/strcoll.c"
...
# 37 "/tools/toolchain/newlib/newlib/libc/string/strcoll.c" 2
