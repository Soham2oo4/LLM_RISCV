...
//  %bb.0:                              //  %entry
	...
	.cfi_offset 8, -52
	sw x15, 28 ( sp )               //  4-byte Folded Spill
	mv x19, x14
	sw x13, 32 ( sp )               //  4-byte Folded Spill
...
.LBB0_24:                               //  %if.end67
	...
	add x16, x14, -1
	and x16, x16, 255
	bltu x15, x16, .LBB0_27
.LBB0_25:                               //  %while.body78.preheader
	add x15, x0, 10
.LBB0_26:                               //  %while.body78
                                        //  =>This Inner Loop Header: Depth=1
	lbu x13, 1 ( x11 )
	hackaton_custom_instr_c x12, x15, x12
	add x11, x11, 1
	add x16, x13, fp
	and x13, x14, 255
	lbu x14, 0 ( x16 )
...
.LBB0_60:                               //  %if.end
	...
	lbu x11, 0 ( x11 )
	beq x0, x11, .LBB0_80
.LBB0_61:                               //  %while.cond16.preheader
	xor x12, x10, 48
	mv x24, x20
	bltu x0, x12, .LBB0_65
.LBB0_62:                               //  %while.body20.preheader
	mv x24, x20
.LBB0_63:                               //  %while.body20
                                        //  =>This Inner Loop Header: Depth=1
	lbu x10, 1 ( x24 )
	add x24, x24, 1
	xor x11, x10, 48
	beq x0, x11, .LBB0_63
.LBB0_64:                               //  %while.end21.loopexit
	add x11, x10, fp
	lbu x11, 0 ( x11 )
.LBB0_65:                               //  %while.end21
	seqz x27, x0
...
.LBB0_97:                               //  %if.end19.i571
	sub x10, x13, x20
	sra x11, x10, 2&31
	sw x11, 16 ( x26 )
	bltu x0, x10, .LBB0_99
.LBB0_98:                               //  %if.then24.i572
	sw x0, 0 ( x20 )
.LBB0_99:                               //  %rshift.exit573
	add x18, x18, x22
	lw x10, 8 ( x24 )
	bge x10, x18, .LBB0_55
.LBB0_100:                              //  %ovfl
...
.LBB0_104:                              //  %do.body.i
	...
	lw x12, 0 ( x10 )
	xor x13, x12, -1
	bltu x0, x13, .LBB0_109
.LBB0_105:                              //  %if.end.i
                                        //    in Loop: Header=BB0_104 Depth=1
	sw x0, 0 ( x10 )
	add x10, x10, 4
	bltu x10, x11, .LBB0_104
.LBB0_106:                              //  %do.end.i
	lw x10, 8 ( x26 )
	bge x9, x10, .LBB0_114
.LBB0_107:
...
.LBB0_72:                               //  %if.else312
	or x22, x22, 16
	jal x0, .LBB0_146
.LBB0_109:                              //  %if.then.i536
	add x11, x12, 1
	sw x11, 0 ( x10 )
	mv x12, x9
	xor x10, x22, 2
	bltu x0, x10, .LBB0_120
.LBB0_117:                              //  %if.then273
	lw x10, 0 ( x24 )
	add x10, x10, -1
	bne x23, x10, .LBB0_127
.LBB0_118:                              //  %land.lhs.true278
	sra x10, x23, 5&31
	sll x10, x10, 2&31
	add x10, x10, x26
	lw x10, 20 ( x10 )
...
.LBB0_120:                              //  %if.else287
	blt x9, x12, .LBB0_124
.LBB0_121:                              //  %lor.lhs.false291
	and x9, x23, 31
	beq x0, x9, .LBB0_156
.LBB0_122:                              //  %land.lhs.true295
	add x10, x26, fp
	lw x10, 16 ( x10 )
	jal __hi0bits
	add x11, x0, 32
	sub x11, x11, x9
	bge x10, x11, .LBB0_156
.LBB0_123:                              //  %land.lhs.true295.if.then302_crit_edge
	lw x12, 16 ( x26 )
.LBB0_124:                              //  %if.then302
	add x10, x26, 20
	mv x13, x10
...
.LBB0_125:                              //  %if.then.i
	...
	xor x13, x12, 1
	srl x11, x11, 1&31
	bltu x0, x13, .LBB0_147
.LBB0_126:
	mv x12, x10
	mv x14, x0
	mv x13, x12
	bne x11, x14, .LBB0_150
	jal x0, .LBB0_151
.LBB0_128:
	mv x10, x0
.LBB0_129:                              //  %if.end234
...
.LBB0_132:                              //  %if.end234
	...
	sra x12, x9, 5&31
	mv x15, x10
	bge x12, x13, .LBB0_143
.LBB0_133:                              //  %if.then.i582
	add x14, x26, 20
	sll x13, x13, 2&31
	sll x12, x12, 2&31
	add x13, x13, x14
	and x15, x9, 31
	beq x0, x15, .LBB0_138
.LBB0_134:                              //  %if.then3.i588
	add x16, x12, x14
	lw x14, 0 ( x16 )
	add x16, x16, 4
	srl x14, x14, x15
	bgeu x16, x13, .LBB0_140
.LBB0_135:                              //  %while.body.i599.preheader
	add x16, x0, 32
	sub x17, x16, x15
	add x16, x26, 24
.LBB0_136:                              //  %while.body.i599
                                        //  =>This Inner Loop Header: Depth=1
	add x5, x12, x16
	lw x6, 0 ( x5 )
	sll x6, x6, x17
	...
	add x5, x12, x16
	srl x14, x14, x15
	bltu x5, x13, .LBB0_136
.LBB0_137:                              //  %while.end.i605.loopexit
	add x12, x16, -4
	mv x15, x12
	beq x14, x11, .LBB0_142
.LBB0_141:                              //  %while.end.i605
	add x15, x12, 4
.LBB0_142:                              //  %while.end.i605
	...
	sra x12, x11, 2&31
	sw x12, 16 ( x26 )
	bltu x0, x11, .LBB0_145
	jal x0, .LBB0_144
.LBB0_138:                              //  %while.body14.i611.preheader
	mv x15, x10
.LBB0_139:                              //  %while.body14.i611
                                        //  =>This Inner Loop Header: Depth=1
	add x11, x12, x15
	lw x11, 0 ( x11 )
	sw x11, 0 ( x15 )
	add x15, x15, 4
	add x11, x12, x15
	bltu x11, x13, .LBB0_139
.LBB0_143:                              //  %if.end19.i618
	sub x11, x15, x10
	sra x12, x11, 2&31
	sw x12, 16 ( x26 )
	bltu x0, x11, .LBB0_145
.LBB0_144:                              //  %if.then24.i619
	sw x0, 0 ( x10 )
.LBB0_145:                              //  %rshift.exit620
	lw x18, 4 ( x24 )
	sub x23, x23, x9
	add x22, x0, 2
	bltu x0, fp, .LBB0_67
...
.LBB0_140:
	...
	beq x14, x11, .LBB0_142
	jal x0, .LBB0_141
.LBB0_147:                              //  %while.body.i.preheader
	sll x12, x12, 2&31
	add x13, x26, 20
	add x13, x12, x13
	mv x12, x10
.LBB0_148:                              //  %while.body.i
                                        //  =>This Inner Loop Header: Depth=1
	lw x14, 4 ( x12 )
	sll x15, x14, 31&31
	or x11, x11, x15
	...
	add x14, x12, 8
	add x12, x12, 4
	bltu x14, x13, .LBB0_148
.LBB0_149:                              //  %while.end.i
	mv x14, x0
	mv x13, x12
	beq x11, x14, .LBB0_151
...
.LBB0_152:                              //  %if.end19.i
	...
	sra x12, x11, 2&31
	sw x12, 16 ( x26 )
	bltu x0, x11, .LBB0_154
.LBB0_153:                              //  %if.then24.i
	sw x0, 0 ( x10 )
.LBB0_154:                              //  %rshift.exit
	lw x10, 8 ( x24 )
	bge x18, x10, .LBB0_100
.LBB0_155:
	add x18, x18, 1
.LBB0_156:                              //  %if.end310
	lw x10, 32 ( sp )               //  4-byte Folded Reload
