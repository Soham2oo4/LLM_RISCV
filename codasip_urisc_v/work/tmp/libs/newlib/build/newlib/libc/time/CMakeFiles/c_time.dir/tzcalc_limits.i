# 1 "/tools/toolchain/newlib/newlib/libc/time/tzcalc_limits.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/time/tzcalc_limits.c" 2
# 11 "/tools/toolchain/newlib/newlib/libc/time/tzcalc_limits.c"
...
# 12 "/tools/toolchain/newlib/newlib/libc/time/tzcalc_limits.c" 2
...
__tzcalc_limits (int year)
{
      ...
      else
 {
   ...
   days += m_day;
      ...
      tz->__tzrule[i].change = (time_t) days * ((60L * 60L) * 24L) +
