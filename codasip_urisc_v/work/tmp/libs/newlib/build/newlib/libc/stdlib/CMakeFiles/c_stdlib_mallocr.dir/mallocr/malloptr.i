# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/malloptr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/malloptr.c" 2
# 30 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/malloptr.c"
...
# 645 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/../nano-mallocr.c"
int _mallopt_r(struct _reent *reent_ptr, int parameter_number, int parameter_value)
{
    return 0;
}
# 31 "/tools/toolchain/newlib/newlib/libc/stdlib/mallocr/malloptr.c" 2
