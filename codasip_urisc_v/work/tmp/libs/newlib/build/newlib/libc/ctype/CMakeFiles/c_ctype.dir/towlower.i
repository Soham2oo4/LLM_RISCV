# 1 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c" 2
# 68 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c"
...
# 69 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c" 2
...
# 70 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c" 2
...
# 71 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c" 2
...
# 72 "/tools/toolchain/newlib/newlib/libc/ctype/towlower.c" 2
...
towlower (wint_t c)
{
  ...
  return c < 0x00ff ? (wint_t)(__extension__ ({ __typeof__ ((int)c) __x = ((int)c); (((((_ctype_)+sizeof(""[__x]))[(int)(__x)])&(01|02))==01) ? (int) __x - 'A' + 'a' : (int) __x;})) : c;
