# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_scalb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_scalb.c" 2
# 22 "/tools/toolchain/newlib/newlib/libm/math/wf_scalb.c"
...
# 23 "/tools/toolchain/newlib/newlib/libm/math/wf_scalb.c" 2
...
# 24 "/tools/toolchain/newlib/newlib/libm/math/wf_scalb.c" 2
...
# 39 "/tools/toolchain/newlib/newlib/libm/math/wf_scalb.c"
{
 ...
 if(!(finitef(z)||(__builtin_isnan (z)))&&finitef(x)) {
     ...
     (*__errno()) = 34;
     return (x > 0.0 ? (__builtin_huge_valf()) : -(__builtin_huge_valf()));
 }
 if(z==0.0f&&z!=x) {
