# 1 "/tools/toolchain/newlib/newlib/libm/math/ef_jn.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/ef_jn.c" 2
# 16 "/tools/toolchain/newlib/newlib/libm/math/ef_jn.c"
...
# 17 "/tools/toolchain/newlib/newlib/libm/math/ef_jn.c" 2
...
# 115 "/tools/toolchain/newlib/newlib/libm/math/ef_jn.c"
  float t,v;
  ...
  a = t;
  b = one;
# 137 "/tools/toolchain/newlib/newlib/libm/math/ef_jn.c"
  tmp = n;
  v = two/x;
