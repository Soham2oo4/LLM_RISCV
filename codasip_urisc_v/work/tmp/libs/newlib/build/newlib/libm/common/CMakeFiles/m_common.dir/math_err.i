# 1 "/tools/toolchain/newlib/newlib/libm/common/math_err.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/math_err.c" 2
# 29 "/tools/toolchain/newlib/newlib/libm/common/math_err.c"
# 1 "/tools/toolchain/newlib/newlib/libm/common/./math_config.h" 1
# 32 "/tools/toolchain/newlib/newlib/libm/common/./math_config.h"
...
# 33 "/tools/toolchain/newlib/newlib/libm/common/./math_config.h" 2
...
# 30 "/tools/toolchain/newlib/newlib/libm/common/math_err.c" 2
...
# 33 "/tools/toolchain/newlib/newlib/libm/common/math_err.c" 2
...
{
  double y = (x - x) / (x - x);
  return (__builtin_isnan (x)) ? y : with_errno (y, 33);
}
...
{
  return y == 0.0 ? with_errno (y, 34) : y;
}

__attribute__ ((__visibility__ ("hidden"))) double
__math_check_oflow (double y)
{
  return (__builtin_isinf_sign (y)) ? with_errno (y, 34) : y;
}
