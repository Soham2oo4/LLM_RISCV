# 1 "/tools/toolchain/newlib/newlib/libm/common/s_expm1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/s_expm1.c" 2
# 144 "/tools/toolchain/newlib/newlib/libm/common/s_expm1.c"
...
# 145 "/tools/toolchain/newlib/newlib/libm/common/s_expm1.c" 2
 ...
 if(hx >= 0x4043687A) {
     if(hx >= 0x40862E42) {
      ...
      if(((hx&0xfffff)|low)!=0)
         ...
         if(x > o_threshold) return __math_oflow (0);
     }
     if(xsb!=0) {
  if(x+tiny<0.0)
  return tiny-one;
