# 1 "/tools/toolchain/newlib/newlib/libm/common/nexttowardf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/nexttowardf.c" 2
# 24 "/tools/toolchain/newlib/newlib/libm/common/nexttowardf.c"
...
# 25 "/tools/toolchain/newlib/newlib/libm/common/nexttowardf.c" 2
...
# 14 "/tools/toolchain/newlib/newlib/libc/include/stdint.h" 3
...
# 26 "/tools/toolchain/newlib/newlib/libc/include/inttypes.h" 2 3
...
# 26 "/tools/toolchain/newlib/newlib/libm/common/nexttowardf.c" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/./local.h" 1
# 27 "/tools/toolchain/newlib/newlib/libm/common/nexttowardf.c" 2
...
nexttowardf (float x, long double y)
{
  ...
  if (x == 0) {
    ux.bits = 1;
    if (((sizeof(y) == sizeof(float)) ? __builtin_signbitf(y) : (sizeof(y) == sizeof(double)) ? __builtin_signbit (y) : __builtin_signbitl(y)))
      ux.bits |= 0x80000000;
  } else if (x < y) {
    if (((sizeof(x) == sizeof(float)) ? __builtin_signbitf(x) : (sizeof(x) == sizeof(double)) ? __builtin_signbit (x) : __builtin_signbitl(x)))
      ux.bits--;
    else
      ux.bits++;
  } else {
