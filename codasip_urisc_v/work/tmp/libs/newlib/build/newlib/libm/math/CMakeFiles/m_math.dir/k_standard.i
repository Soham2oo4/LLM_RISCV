# 1 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c" 2
# 15 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c"
...
# 16 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c" 2
...
# 17 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c" 2
...
# 20 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c" 2
...
# 82 "/tools/toolchain/newlib/newlib/libm/math/k_standard.c"
...

{
 ...
 switch(type) {
  ...
  retval = ( (x>zero) ? (__builtin_huge_val()) : -(__builtin_huge_val()));
  (*__errno()) = 34;
  break;
     case 26:
     case 126:
  ...
  retval = copysign((__builtin_huge_val()), x);
  (*__errno()) = 34;
  break;
     case 41:
     case 141:
