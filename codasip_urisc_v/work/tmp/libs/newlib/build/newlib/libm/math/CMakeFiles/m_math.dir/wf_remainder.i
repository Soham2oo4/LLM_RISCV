# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_remainder.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_remainder.c" 2
# 20 "/tools/toolchain/newlib/newlib/libm/math/wf_remainder.c"
...
# 21 "/tools/toolchain/newlib/newlib/libm/math/wf_remainder.c" 2
...
# 22 "/tools/toolchain/newlib/newlib/libm/math/wf_remainder.c" 2
...

{
 ...
 if(0 == -1 || (__builtin_isnan (y))) return z;
 if(y==0.0f) {
