# 1 "/tools/toolchain/newlib/newlib/libm/complex/casinf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/complex/casinf.c" 2
# 35 "/tools/toolchain/newlib/newlib/libm/complex/casinf.c"
...
# 36 "/tools/toolchain/newlib/newlib/libm/complex/casinf.c" 2
...
# 37 "/tools/toolchain/newlib/newlib/libm/complex/casinf.c" 2
...
casinf(float _Complex z)
{
 ...
 x = crealf(z);
 y = cimagf(z);
# 107 "/tools/toolchain/newlib/newlib/libm/complex/casinf.c"
 ca = x + y * 1.0fi;
 ct = ca * 1.0fi;
