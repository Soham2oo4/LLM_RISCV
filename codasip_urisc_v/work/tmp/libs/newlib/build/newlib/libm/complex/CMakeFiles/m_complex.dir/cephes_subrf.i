# 1 "/tools/toolchain/newlib/newlib/libm/complex/cephes_subrf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/complex/cephes_subrf.c" 2
# 35 "/tools/toolchain/newlib/newlib/libm/complex/cephes_subrf.c"
...
# 36 "/tools/toolchain/newlib/newlib/libm/complex/cephes_subrf.c" 2
...
# 37 "/tools/toolchain/newlib/newlib/libm/complex/cephes_subrf.c" 2
# 1 "/tools/toolchain/newlib/newlib/libm/complex/./cephes_subrf.h" 1


void _cchshf(float, float *, float *);
float _redupif(float);
float _ctansf(float _Complex);
# 38 "/tools/toolchain/newlib/newlib/libm/complex/cephes_subrf.c" 2
