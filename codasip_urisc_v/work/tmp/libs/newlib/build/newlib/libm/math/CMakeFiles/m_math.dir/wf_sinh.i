# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_sinh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_sinh.c" 2
# 20 "/tools/toolchain/newlib/newlib/libm/math/wf_sinh.c"
...
# 21 "/tools/toolchain/newlib/newlib/libm/math/wf_sinh.c" 2
...
# 22 "/tools/toolchain/newlib/newlib/libm/math/wf_sinh.c" 2
...

{
 ...
 if(!finitef(z)&&finitef(x)) {
     ...
     (*__errno()) = 34;
     return ( (x>0.0f) ? (__builtin_huge_valf()) : -(__builtin_huge_valf()));
 } else
     return z;
