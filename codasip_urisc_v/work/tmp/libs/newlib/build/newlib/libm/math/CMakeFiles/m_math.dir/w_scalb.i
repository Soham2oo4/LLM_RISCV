# 1 "/tools/toolchain/newlib/newlib/libm/math/w_scalb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/w_scalb.c" 2
# 20 "/tools/toolchain/newlib/newlib/libm/math/w_scalb.c"
...
# 21 "/tools/toolchain/newlib/newlib/libm/math/w_scalb.c" 2
...
# 22 "/tools/toolchain/newlib/newlib/libm/math/w_scalb.c" 2
...
# 39 "/tools/toolchain/newlib/newlib/libm/math/w_scalb.c"
{
 ...
 if(!(finite(z)||(__builtin_isnan (z)))&&finite(x)) {
     ...
     (*__errno()) = 34;
     return (x > 0.0 ? (__builtin_huge_val()) : -(__builtin_huge_val()));
 }
 if(z==0.0&&z!=x) {
