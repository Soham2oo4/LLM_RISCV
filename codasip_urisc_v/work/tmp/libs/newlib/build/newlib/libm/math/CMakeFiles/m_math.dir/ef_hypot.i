# 1 "/tools/toolchain/newlib/newlib/libm/math/ef_hypot.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/ef_hypot.c" 2
# 16 "/tools/toolchain/newlib/newlib/libm/math/ef_hypot.c"
...
# 17 "/tools/toolchain/newlib/newlib/libm/math/ef_hypot.c" 2
...

{
 ...
 if (w>b) {
     ...
     y2 = b - y1;
     do { ieee_float_shape_type sf_u; sf_u.word = ((ha+0x00800000L)&0xfffff000UL); (t1) = sf_u.value; } while (0);
     t2 = a - t1;
