# 1 "/tools/toolchain/newlib/newlib/libm/common/s_modf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/s_modf.c" 2
# 62 "/tools/toolchain/newlib/newlib/libm/common/s_modf.c"
...
# 63 "/tools/toolchain/newlib/newlib/libm/common/s_modf.c" 2
...

{
 ...
 if(j0<20) {
  ...
  if(((i0&i)|i1)==0) {
      *iptr = x;
      do { ieee_double_shape_type iw_u; iw_u.parts.msw = (i0&0x80000000); iw_u.parts.lsw = (0); (x) = iw_u.value; } while (0);
      return x;
  } else {
     ...
     *iptr = x;
     if (__fpclassifyd(x) == 0) return *iptr = x+x;
     do { ieee_double_shape_type iw_u; iw_u.parts.msw = (i0&0x80000000); iw_u.parts.lsw = (0); (x) = iw_u.value; } while (0);
     return x;
 } else {
