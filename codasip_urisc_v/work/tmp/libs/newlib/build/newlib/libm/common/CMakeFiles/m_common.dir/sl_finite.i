# 1 "/tools/toolchain/newlib/newlib/libm/common/sl_finite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/sl_finite.c" 2
...
# 10 "/tools/toolchain/newlib/newlib/libm/common/sl_finite.c" 2
...
finitel (long double x)
{
  ...
  return finite (x);
# 24 "/tools/toolchain/newlib/newlib/libm/common/sl_finite.c"
}
