# 1 "/tools/toolchain/newlib/newlib/libm/complex/casin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/complex/casin.c" 2
# 78 "/tools/toolchain/newlib/newlib/libm/complex/casin.c"
...
# 79 "/tools/toolchain/newlib/newlib/libm/complex/casin.c" 2
...
# 80 "/tools/toolchain/newlib/newlib/libm/complex/casin.c" 2
...
casin(double _Complex z)
{
 ...
 x = creal(z);
 y = cimag(z);
# 150 "/tools/toolchain/newlib/newlib/libm/complex/casin.c"
 ca = x + y * 1.0fi;
 ct = ca * 1.0fi;
