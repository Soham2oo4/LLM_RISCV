# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_log.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/wf_log.c" 2
# 20 "/tools/toolchain/newlib/newlib/libm/math/wf_log.c"
...
# 21 "/tools/toolchain/newlib/newlib/libm/math/wf_log.c" 2
...
# 23 "/tools/toolchain/newlib/newlib/libm/math/wf_log.c" 2
...

{
 ...
 float z;
 z = __ieee754_logf(x);
 if(0 == -1 || (__builtin_isnan (x)) || x > 0.0f) return z;
 if(x==0.0f) {
