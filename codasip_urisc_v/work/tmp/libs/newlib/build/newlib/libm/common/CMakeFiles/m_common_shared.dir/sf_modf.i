# 1 "/tools/toolchain/newlib/newlib/libm/common/sf_modf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/sf_modf.c" 2
# 16 "/tools/toolchain/newlib/newlib/libm/common/sf_modf.c"
...
# 17 "/tools/toolchain/newlib/newlib/libm/common/sf_modf.c" 2
...

{
 ...
 if(j0<23) {
  ...
  if((i0&i)==0) {
      *iptr = x;
      do { ieee_float_shape_type sf_u; sf_u.word = (i0&0x80000000); (x) = sf_u.value; } while (0);
      return x;
  } else {
     ...
     *iptr = x;
     if (__fpclassifyf(x) == 0) return *iptr = x+x;
     do { ieee_float_shape_type sf_u; sf_u.word = (i0&0x80000000); (x) = sf_u.value; } while (0);
     return x;
 }
}
