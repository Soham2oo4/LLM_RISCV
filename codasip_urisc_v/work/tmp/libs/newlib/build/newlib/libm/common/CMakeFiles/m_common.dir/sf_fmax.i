# 1 "/tools/toolchain/newlib/newlib/libm/common/sf_fmax.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/sf_fmax.c" 2
...
# 8 "/tools/toolchain/newlib/newlib/libm/common/sf_fmax.c" 2
