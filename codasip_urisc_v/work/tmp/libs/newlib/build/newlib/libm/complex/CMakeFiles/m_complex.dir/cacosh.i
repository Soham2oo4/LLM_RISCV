# 1 "/tools/toolchain/newlib/newlib/libm/complex/cacosh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/complex/cacosh.c" 2
# 80 "/tools/toolchain/newlib/newlib/libm/complex/cacosh.c"
...
# 81 "/tools/toolchain/newlib/newlib/libm/complex/cacosh.c" 2

double _Complex
cacosh(double _Complex z)
{
 double _Complex w;
