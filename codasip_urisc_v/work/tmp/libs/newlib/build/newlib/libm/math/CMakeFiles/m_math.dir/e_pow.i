# 1 "/tools/toolchain/newlib/newlib/libm/math/e_pow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/e_pow.c" 2
# 60 "/tools/toolchain/newlib/newlib/libm/math/e_pow.c"
...
# 61 "/tools/toolchain/newlib/newlib/libm/math/e_pow.c" 2
...

{
 ...
 if (j>=0x40900000) {
     if(((j-0x40900000)|i)!=0)
  return __math_oflow(s<0);
     else {
  if(p_l+ovt>z-p_h) return __math_oflow(s<0);
     }
 } else if((j&0x7fffffff)>=0x4090cc00 ) {
     if(((j-0xc090cc00)|i)!=0)
  return __math_uflow(s<0);
     else {
  if(p_l<=z-p_h) return __math_uflow(s<0);
     }
 }
