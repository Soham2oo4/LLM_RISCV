# 1 "/tools/toolchain/newlib/newlib/libm/math/w_log.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/w_log.c" 2
# 47 "/tools/toolchain/newlib/newlib/libm/math/w_log.c"
...
# 48 "/tools/toolchain/newlib/newlib/libm/math/w_log.c" 2
...
# 50 "/tools/toolchain/newlib/newlib/libm/math/w_log.c" 2
...

{
 ...
 double z;
 z = __ieee754_log(x);
 if(0 == -1 || (__builtin_isnan (x)) || x > 0.0) return z;
 if(x==0.0) {
