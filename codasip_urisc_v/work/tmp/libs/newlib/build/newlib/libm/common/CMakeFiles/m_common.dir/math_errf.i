# 1 "/tools/toolchain/newlib/newlib/libm/common/math_errf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/common/math_errf.c" 2
# 29 "/tools/toolchain/newlib/newlib/libm/common/math_errf.c"
...
# 30 "/tools/toolchain/newlib/newlib/libm/common/math_errf.c" 2
...
# 34 "/tools/toolchain/newlib/newlib/libm/common/math_errf.c" 2
...
{
  y = (sign ? -y : y) * y;
  return with_errnof (y, 34);
}

__attribute__ ((__visibility__ ("hidden"))) float
__math_uflowf (uint32_t sign)
{
  return xflowf (sign, 0x1p-95f);
}
# 72 "/tools/toolchain/newlib/newlib/libm/common/math_errf.c"
__attribute__ ((__visibility__ ("hidden"))) float
...
{
  float y = 0;
  return with_errnof ((sign ? -1 : 1) / y, 34);
}
...
{
  float y = (x - x) / (x - x);
  return (__builtin_isnan (x)) ? y : with_errnof (y, 33);
}
