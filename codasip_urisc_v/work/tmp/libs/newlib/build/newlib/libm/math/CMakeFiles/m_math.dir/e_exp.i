# 1 "/tools/toolchain/newlib/newlib/libm/math/e_exp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/toolchain/newlib/newlib/libm/math/e_exp.c" 2
# 77 "/tools/toolchain/newlib/newlib/libm/math/e_exp.c"
...
# 78 "/tools/toolchain/newlib/newlib/libm/math/e_exp.c" 2
...

{
 ...
 if(hx >= 0x40862E42) {
  ...
  if(((hx&0xfffff)|lx)!=0)
     ...
     if(x < u_threshold) return __math_uflow(0);
 }
