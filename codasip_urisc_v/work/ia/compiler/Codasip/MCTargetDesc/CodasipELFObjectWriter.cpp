...
cl::opt<bool> RiscvTarget("riscv-target",
                          cl::desc("Codasip C/C++ Compiler use RISC-V target "
                                   "to produce compatible RISC-V ELF"),
                          cl::init(false));
...
class RelocationExpressionTableBuilder {
  ...
  // Provides map to quickly reuse index of already generated relocation
  // expression
...
class CodasipELFObjectWriter : public MCELFObjectTargetWriter {
  ...
  void createRelocationExpression(raw_ostream &OS, const MCExpr *Expression,
                                  const MCSymbol &OperandSymbol,
                                  const bool IsPCRel, const MCAsmInfo *MAI,
                                  const bool IsSigned,
...
RelocationExpressionTableBuilder::RelocationExpressionTableBuilder() : Size(0) {
  // TODO is this valid?
...
CodasipELFObjectWriter::CodasipELFObjectWriter(uint8_t OSABI)
    : MCELFObjectTargetWriter(
          /*Is64Bit*/ 0,
          OSABI, RiscvTarget ? ELF::EM_RISCV : ELF::EM_CODASIP,
          /*HasRelocationAddend*/ true) {}

CodasipELFObjectWriter::~CodasipELFObjectWriter() {}

unsigned
CodasipELFObjectWriter::getRelocType(MCContext &Ctx, const MCValue &Target,
                                     const MCFixup &Fixup, bool IsPCRel,
  ...
  if (RiscvTarget) {
    ...
    if (IsPCRel) {
      switch (Kind) {
      default:
        // Following line has to be removed when RISC-V and Codasip relocations
        // works together
        dbgs() << "FixupKind=" << Fixup.getKind() << "\n";
  ...
  case Codasip::FK_Codasip_MI3valIH1_10start_base14_11imm20_reloc3imm1_14imm20_pcrel_hi: {
    ExpressionStr = " (  (  (  (  ( " + ExpressionStr + " -  u64  (  u64  ( current_address )  )  )  +  i32  ( 0x800 )  )  )  >>  i32  ( 0xc )  )  &  i32  ( 0xfffff )  ) ";
    break;
  }
  ...
  case Codasip::FK_Codasip_MI3valIH1_10start_base8_6simm126simm121_15simm12_pcrel_lo: {
    ExpressionStr = " (  (  ( " + ExpressionStr + " -  u64  (  u64  ( current_address )  )  )  )  &  i32  ( 0xfff )  ) ";
    break;
  }
  ...
  case Codasip::FK_Codasip_MI4addrIH1_10start_base13_10rel_addr324addr1_10rel_addr32: {
    ExpressionStr = " ( (  (  (  (  ( " + ExpressionStr + " -  i64  (  i64  ( current_address )  )  )  )  &  i32  ( 0x800 )  )  )  ) ? (  (  (  (  (  ( " + ExpressionStr + " -  i64  (  i64  ( current_address )  )  )  )  +  i32  ( 0x1000 )  )  )  &  u32  ( 0xffffffff )  )  ) : (  (  (  ( " + ExpressionStr + " -  i64  (  i64  ( current_address )  )  )  )  &  u32  ( 0xffffffff )  )  ) ) ";
    break;
  }
  case Codasip::FK_Codasip_MI4addrIH1_10start_base17_14imm32_lui_addi3imm1_14imm32_lui_addi: {
    ExpressionStr = " ( (  (  ( " + ExpressionStr + " &  i32  ( 0x800 )  )  )  ) ? (  (  (  ( " + ExpressionStr + " +  i32  ( 0x1000 )  )  )  &  u32  ( 0xffffffff )  )  ) : (  ( " + ExpressionStr + " &  u32  ( 0xffffffff )  )  ) ) ";
    break;
  }
  ...
  default:
    ...
    // Enhance expression to correct bit manipulation, depends on placement
    // position (MSB, MID, LSB)
  ...
  // Hoping that nobody later touches MXFixup.ByteCount, MXFixup.MsbOut and
  // MXFixup.LsbOut
  ...
  case Codasip::FK_Codasip_MI3immIH1_10start_base11_9imm20_s123imm1_9imm20_s12:
  case Codasip::FK_Codasip_MI3immIH1_10start_base1_10load_imm32:
  case Codasip::FK_Codasip_MI3immIH1_10start_base1_8c_lui_hi:
  case Codasip::FK_Codasip_MI3immIH1_10start_base1_9c_addi_lo:
  case Codasip::FK_Codasip_MI3immIH1_10start_base6_4imm53imm1_4imm5:
  case Codasip::FK_Codasip_MI3immIH1_10start_base8_6op_csr3csr1_7csr_imm:
  case Codasip::FK_Codasip_MI3valIH1_10start_base10_8imm20_hi3imm1_8imm20_hi:
  case Codasip::FK_Codasip_MI3valIH1_10start_base10_8simm12_s8simm12_s1_11simm12_s_lo:
  case Codasip::FK_Codasip_MI3valIH1_10start_base10_8simm12_s8simm12_s1_17simm12_s_pcrel_lo:
  case Codasip::FK_Codasip_MI3valIH1_10start_base14_11imm20_reloc3imm1_14imm20_pcrel_hi:
  ...
  case Codasip::FK_Codasip_MI3valIH1_10start_base8_6simm126simm121_15simm12_pcrel_lo:
  case Codasip::FK_Codasip_MI3valIH1_10start_base8_6simm126simm121_9simm12_lo:
  case Codasip::FK_Codasip_MI5shiftIH1_10start_base11_9shift_imm3imm1_9shift_imm:
    return ELF::R_CODASIP_EXPR;
  case Codasip::FK_Codasip_MI4addrIH1_10start_base13_10rel_addr324addr1_10rel_addr32:
  case Codasip::FK_Codasip_MI4addrIH1_10start_base17_14imm32_lui_addi3imm1_14imm32_lui_addi:
  case Codasip::FK_Codasip_MI4addrIH1_10start_base23_20rel_addr32_call_tail4addr1_27rel_addr32_call_tail_simple:
  ...
  case Codasip::FK_Codasip_MI4addrIH1_10start_base13_10rel_addr124addr1_10rel_addr12:
  case Codasip::FK_Codasip_MI4addrIH1_10start_base13_10rel_addr204addr1_10rel_addr20:
  case Codasip::FK_Codasip_MI4simmIH1_10start_base10_8simm12_s8simm12_s1_13simm12_simple:
  case Codasip::FK_Codasip_MI4simmIH1_10start_base8_6simm126simm121_13simm12_simple:
...
bool CodasipELFObjectWriter::needsRelocateWithSymbol(const MCSymbol &,
                                                     unsigned) const {
  // Codasip support relocations with symbol only (Not the section symbol +
  // offset)
  return true;
}
...
void CodasipELFObjectWriter::addTargetSectionFlags(MCContext &Ctx,
  ...
  if (Type != ELF::SHT_STRTAB && Type != ELF::SHT_SYMTAB &&
      ...
      Type != ELF::SHT_DYNSYM && Type != ELF::SHT_CODASIP_AS &&
...
unsigned
CodasipELFObjectWriter::DetermineAddressSpaceIndex(unsigned Flags) const {
  unsigned Index = DataAddressSpaceIndex;
  if (ProgramAddressSpaceIndex != DataAddressSpaceIndex &&
      (Flags & ELF::SHF_EXECINSTR))
    Index = ProgramAddressSpaceIndex;
  return Index;
}

void CodasipELFObjectWriter::createRelocationExpression(
    raw_ostream &OS, const MCExpr *Expression, const MCSymbol &OperandSymbol,
  ...
  case MCExpr::Target: {
    const CodasipTernaryMCExpr &Ternary =
        cast<CodasipTernaryMCExpr>(*Expression);
    OS << " ( ";
    createRelocationExpression(OS, &Ternary.getCondition(), OperandSymbol,
                               IsPCRel, MAI, IsSigned);
    OS << " ? ";
    createRelocationExpression(OS, &Ternary.getTrue(), OperandSymbol, IsPCRel,
                               MAI, IsSigned);
    OS << " : ";
    createRelocationExpression(OS, &Ternary.getFalse(), OperandSymbol, IsPCRel,
                               MAI, IsSigned);
    OS << " )";
    return;
  }
  ...
  case MCExpr::Unary: {
    ...
    // TODO This hack is needed because linker does not support any unary
    // operation
    ...
    if (BinaryHack)
      OS << " ( 0 ";
    OS << " " << Operation << " ";
    createRelocationExpression(OS, UE.getSubExpr(), OperandSymbol, IsPCRel, MAI,
                               IsSigned);
    if (BinaryHack)
      OS << " ) ";
    return;
  ...
  case MCExpr::Binary: {
    ...
    OS << " ( ";
    createRelocationExpression(OS, BE.getLHS(), OperandSymbol, IsPCRel, MAI,
                               IsSigned);
    OS << " ";
    ...
    OS << " ";
    createRelocationExpression(OS, BE.getRHS(), OperandSymbol, IsPCRel, MAI,
                               IsSigned);
    OS << " ) ";
...
llvm::createCodasipELFObjectWriter(uint8_t OSABI) {
