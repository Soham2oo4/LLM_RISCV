...
public:
   ...
   * Created during analysis of formal arguments. Intented for usage in prologue
   * emition - va_start needs this in constants. */
  struct ArgsInfo {
...
inline void CodasipGenFunctionInfo::MarkOutFI(int FI) { FI_Outs.insert(FI); }
