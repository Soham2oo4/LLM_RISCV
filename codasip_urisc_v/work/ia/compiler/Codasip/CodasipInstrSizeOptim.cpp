...
newOpc.reserve(5);
newOpc.push_back(Codasip::i_comp_2reg_imm__opc_addi__regs__reg0__simm12_simple__);
newOpc.push_back(Codasip::i_comp_2reg_imm__opc_ori__regs__reg0__simm12_simple__);
newOpc.push_back(Codasip::i_comp_2reg_imm__opc_xori__regs__reg0__simm12_simple__);
newOpc.push_back(Codasip::i_lui__opc_lui__regs__imm20_s12__);
newOpc.push_back(Codasip::i_ori_emulation_alias__regs__reg0__simm12_simple__);
break;
case Codasip::i_store__opc_storew__regs__simm12_simple__regs__1_BIGIMM_EMUL_:
newOpc.reserve(1);
newOpc.push_back(Codasip::i_store__opc_storew__regs__simm12_simple__regs__);
break;
case Codasip::i_load__opc_loadw__regs__simm12_simple__regs__3_BIGIMM_EMUL_:
newOpc.reserve(1);
newOpc.push_back(Codasip::i_load__opc_loadw__regs__simm12_simple__regs__);
break;
...
newOpc.reserve(1);
newOpc.push_back(Codasip::i_comp_2reg_imm__opc_addi__regs__regs__simm12_simple__);
break;
...
bool SmallerInstructions::implicitDefsCheck(unsigned opcode,
  ...
  for (unsigned oldIdx = 0; oldIdx < mi->getDesc().getNumImplicitDefs();
    ...
    if (!found) {
      ...
      // is it a dropped auxiliary reg (of an emulation) or a completely unused
      // reg?
