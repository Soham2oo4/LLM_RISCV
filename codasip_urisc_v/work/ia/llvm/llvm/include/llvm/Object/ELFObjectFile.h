...
protected:
  ...
  // ==== CODASIP ====
  virtual uint64_t getSectionInfo(DataRefImpl Sec) const = 0;
  // =================
...
public:
  ...
  uint64_t getInfo() const {
    return getObject()->getSectionInfo(getRawDataRefImpl());
  }
  // =================
};
...
protected:
  ...
  // =================== CODASIP ===================
  bool useDefaultAS(DataRefImpl Sec) const override;
  // ===============================================
  ...
  // ==== CODASIP ====
  uint64_t getSectionInfo(DataRefImpl Sec) const override;
  // =================
...
// ==== CODASIP ====
template <class ELFT>
uint64_t ELFObjectFile<ELFT>::getSectionInfo(DataRefImpl Sec) const {
  return getSection(Sec)->sh_info;
}
// =================
...
// ========================== CODASIP ==========================
template <class ELFT>
bool ELFObjectFile<ELFT>::useDefaultAS(DataRefImpl Sec) const {
  const Elf_Shdr *EShdr = getSection(Sec);
  return EShdr->sh_type == ELF::SHT_REL ||
         EShdr->sh_type == ELF::SHT_RELA ||
         EShdr->sh_type == ELF::SHT_SYMTAB ||
         EShdr->sh_type == ELF::SHT_DYNSYM ||
         EShdr->sh_type == ELF::SHT_GROUP;
}
// =============================================================
...
StringRef ELFObjectFile<ELFT>::getFileFormatName() const {
  ...
  case ELF::ELFCLASS32:
    ...
    //============================ CODASIP =============================
    case ELF::EM_CODASIP:
      return (IsLittleEndian ? "elf32-codasip-le" : "elf32-codasip-be");
    //==================================================================
    default:
  ...
  case ELF::ELFCLASS64:
    ...
    //============================ CODASIP =============================
    case ELF::EM_CODASIP:
      return (IsLittleEndian ? "elf64-codasip-le" : "elf64-codasip-be");
    //==================================================================
    default:
