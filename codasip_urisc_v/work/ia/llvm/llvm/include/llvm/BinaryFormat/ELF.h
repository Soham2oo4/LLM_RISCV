...
enum : unsigned {
  ...
  // ============ CODASIP ============
  // Non-standard extensions 24b-31b
  EF_RISCV_RVZCMT = 0x1000000,
  // =================================
  EF_RISCV_RVE = 0x0008
};
...
//============ CODASIP ============
// ELF Relocation type for Codasip
enum {
#include "ELFRelocs/Codasip.def"
};
//=================================
...
enum : unsigned {
  ...
  //======================== CODASIP ========================
  SHT_CODASIP_AS = (ELF::SHT_LOPROC + 0),
  SHT_CODASIP_RELOCATION_EXPRESSION = (ELF::SHT_LOPROC + 10),
  //=========================================================
...
enum : unsigned {
  ...
  //======== CODASIP =======
  // Section has absolute address set, obviously it is same as 0x10000000 before
  , SHF_ABSOLUTE = (1 << 28)
  //========================
};
