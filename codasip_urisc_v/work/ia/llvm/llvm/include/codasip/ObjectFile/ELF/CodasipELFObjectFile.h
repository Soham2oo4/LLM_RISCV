 ...
 */
#ifndef LLVM_INCLUDE_CODASIP_OBJECTFILE_ELF_CODASIPELFOBJECTFILE_H_
#define LLVM_INCLUDE_CODASIP_OBJECTFILE_ELF_CODASIPELFOBJECTFILE_H_

#include "codasip/ObjectFile/CodasipObjectFile.h"

namespace llvm {

class CodasipELFObjectFile : public CodasipObjectFile {
public:
  CodasipELFObjectFile(object::OwningBinary<object::Binary> owner,
...
#endif /* LLVM_INCLUDE_CODASIP_OBJECTFILE_ELF_CODASIPELFOBJECTFILE_H_ */
