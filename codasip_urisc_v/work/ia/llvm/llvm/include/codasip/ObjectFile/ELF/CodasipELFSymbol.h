 ...
 */
#ifndef LLVM_INCLUDE_CODASIP_OBJECTFILE_ELF_CODASIPELFSYMBOL_H_
#define LLVM_INCLUDE_CODASIP_OBJECTFILE_ELF_CODASIPELFSYMBOL_H_
...
class CodasipELFSymbol : public CodasipSymbol {
public:
  CodasipELFSymbol(const object::ELFSymbolRef &symbol,
...
private:
  const object::ELFSymbolRef Symbol;
};

inline const object::SymbolRef &CodasipELFSymbol::getReference() const {
  return Symbol;
}

} // namespace llvm

#endif /* LLVM_INCLUDE_CODASIP_OBJECTFILE_ELF_CODASIPELFSYMBOL_H_ */
