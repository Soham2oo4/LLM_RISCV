...
CodasipGenTargetLowering::CodasipGenTargetLowering(CodasipTargetMachine &TM)
  ...
  // set legal actions
    addRegisterClass(MVT::i32, &Codasip::regsRegClass);
  ...
  for (int i = 0; i < MVT::LAST_VALUETYPE; ++i) {
    ...
    setOperationAction(ISD::DYNAMIC_STACKALLOC, MVT::SimpleValueType(i),
                       Expand);
    ...
    setOperationAction(ISD::FRAME_TO_ARGS_OFFSET, MVT::SimpleValueType(i),
                       Custom);
  ...
  for (int i = MVT::FIRST_FP_VALUETYPE; i < MVT::LAST_FP_VALUETYPE; ++i) {
    for (int j = MVT::FIRST_FP_VALUETYPE; j < i; ++j) {
      setTruncStoreAction(MVT::SimpleValueType(i), MVT::SimpleValueType(j),
                          Custom);
    }
  }
  // inreg sexts
...
setBooleanVectorContents(ZeroOrOneBooleanContent);
  ...
  // note: the documentation says that the argument should be log2(n) but that's
  // wrong
  ...
  NameMap.insert(std::make_pair("rf_gpr_0", RcAndReg(Codasip::rf_gpr_0, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_1", RcAndReg(Codasip::rf_gpr_1, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_2", RcAndReg(Codasip::rf_gpr_2, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_3", RcAndReg(Codasip::rf_gpr_3, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_4", RcAndReg(Codasip::rf_gpr_4, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_5", RcAndReg(Codasip::rf_gpr_5, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_6", RcAndReg(Codasip::rf_gpr_6, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_7", RcAndReg(Codasip::rf_gpr_7, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_8", RcAndReg(Codasip::rf_gpr_8, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_9", RcAndReg(Codasip::rf_gpr_9, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_10", RcAndReg(Codasip::rf_gpr_10, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_11", RcAndReg(Codasip::rf_gpr_11, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_12", RcAndReg(Codasip::rf_gpr_12, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_13", RcAndReg(Codasip::rf_gpr_13, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_14", RcAndReg(Codasip::rf_gpr_14, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_15", RcAndReg(Codasip::rf_gpr_15, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_16", RcAndReg(Codasip::rf_gpr_16, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_17", RcAndReg(Codasip::rf_gpr_17, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_18", RcAndReg(Codasip::rf_gpr_18, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_19", RcAndReg(Codasip::rf_gpr_19, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_20", RcAndReg(Codasip::rf_gpr_20, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_21", RcAndReg(Codasip::rf_gpr_21, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_22", RcAndReg(Codasip::rf_gpr_22, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_23", RcAndReg(Codasip::rf_gpr_23, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_24", RcAndReg(Codasip::rf_gpr_24, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_25", RcAndReg(Codasip::rf_gpr_25, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_26", RcAndReg(Codasip::rf_gpr_26, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_27", RcAndReg(Codasip::rf_gpr_27, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_28", RcAndReg(Codasip::rf_gpr_28, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_29", RcAndReg(Codasip::rf_gpr_29, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_30", RcAndReg(Codasip::rf_gpr_30, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("rf_gpr_31", RcAndReg(Codasip::rf_gpr_31, &Codasip::rf_gprRegClass)));
  NameMap.insert(std::make_pair("regs", RcAndReg(0, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("ra", RcAndReg(Codasip::rf_gpr_1, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x1", RcAndReg(Codasip::rf_gpr_1, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("sp", RcAndReg(Codasip::rf_gpr_2, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x2", RcAndReg(Codasip::rf_gpr_2, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x3", RcAndReg(Codasip::rf_gpr_3, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("gp", RcAndReg(Codasip::rf_gpr_3, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x4", RcAndReg(Codasip::rf_gpr_4, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("tp", RcAndReg(Codasip::rf_gpr_4, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x5", RcAndReg(Codasip::rf_gpr_5, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t0", RcAndReg(Codasip::rf_gpr_5, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x6", RcAndReg(Codasip::rf_gpr_6, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t1", RcAndReg(Codasip::rf_gpr_6, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x7", RcAndReg(Codasip::rf_gpr_7, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t2", RcAndReg(Codasip::rf_gpr_7, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("fp", RcAndReg(Codasip::rf_gpr_8, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x8", RcAndReg(Codasip::rf_gpr_8, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s0", RcAndReg(Codasip::rf_gpr_8, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x9", RcAndReg(Codasip::rf_gpr_9, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s1", RcAndReg(Codasip::rf_gpr_9, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x10", RcAndReg(Codasip::rf_gpr_10, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a0", RcAndReg(Codasip::rf_gpr_10, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x11", RcAndReg(Codasip::rf_gpr_11, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a1", RcAndReg(Codasip::rf_gpr_11, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x12", RcAndReg(Codasip::rf_gpr_12, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a2", RcAndReg(Codasip::rf_gpr_12, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x13", RcAndReg(Codasip::rf_gpr_13, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a3", RcAndReg(Codasip::rf_gpr_13, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x14", RcAndReg(Codasip::rf_gpr_14, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a4", RcAndReg(Codasip::rf_gpr_14, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x15", RcAndReg(Codasip::rf_gpr_15, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a5", RcAndReg(Codasip::rf_gpr_15, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x16", RcAndReg(Codasip::rf_gpr_16, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a6", RcAndReg(Codasip::rf_gpr_16, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x17", RcAndReg(Codasip::rf_gpr_17, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("a7", RcAndReg(Codasip::rf_gpr_17, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x18", RcAndReg(Codasip::rf_gpr_18, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s2", RcAndReg(Codasip::rf_gpr_18, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x19", RcAndReg(Codasip::rf_gpr_19, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s3", RcAndReg(Codasip::rf_gpr_19, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x20", RcAndReg(Codasip::rf_gpr_20, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s4", RcAndReg(Codasip::rf_gpr_20, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x21", RcAndReg(Codasip::rf_gpr_21, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s5", RcAndReg(Codasip::rf_gpr_21, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x22", RcAndReg(Codasip::rf_gpr_22, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s6", RcAndReg(Codasip::rf_gpr_22, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x23", RcAndReg(Codasip::rf_gpr_23, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s7", RcAndReg(Codasip::rf_gpr_23, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x24", RcAndReg(Codasip::rf_gpr_24, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s8", RcAndReg(Codasip::rf_gpr_24, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x25", RcAndReg(Codasip::rf_gpr_25, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s9", RcAndReg(Codasip::rf_gpr_25, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x26", RcAndReg(Codasip::rf_gpr_26, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s10", RcAndReg(Codasip::rf_gpr_26, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x27", RcAndReg(Codasip::rf_gpr_27, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("s11", RcAndReg(Codasip::rf_gpr_27, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x28", RcAndReg(Codasip::rf_gpr_28, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t3", RcAndReg(Codasip::rf_gpr_28, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x29", RcAndReg(Codasip::rf_gpr_29, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t4", RcAndReg(Codasip::rf_gpr_29, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x30", RcAndReg(Codasip::rf_gpr_30, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t5", RcAndReg(Codasip::rf_gpr_30, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("x31", RcAndReg(Codasip::rf_gpr_31, &Codasip::regsRegClass)));
  NameMap.insert(std::make_pair("t6", RcAndReg(Codasip::rf_gpr_31, &Codasip::regsRegClass)));
  
}

// Get a Function from a callee node.
// Returns nullptr if external symbol.
inline const Function *getFunction(const SDValue &Callee) {
  const auto *GA = dyn_cast<GlobalAddressSDNode>(Callee);
  if (!GA)
    return nullptr;
  return dyn_cast<Function>(GA->getGlobal());
}

SDValue
CodasipGenTargetLowering::LowerCall(TargetLowering::CallLoweringInfo &CLI,
  ...
  const CodasipTargetMachine &CTM =
      static_cast<const CodasipTargetMachine &>(getTargetMachine());
  ...
  for (unsigned i = 0; i < ArgLocs.size(); ++i) {
    ...
    if (Flags.isByVal()) {
      ...
      if (size) {
        ...
        SDValue PtrDst = DAG.getFrameIndex(
            FI, getPointerTy(td, 0)); // that 0 is addres space
        ...
        // copy
        SDValue Size =
            DAG.getConstant(size, dl, getPointerTy(td, 0), false, false);
        MachinePointerInfo dstInfo = MachinePointerInfo::getFixedStack(MF, FI);
        MachinePointerInfo srcInfo = MachinePointerInfo();
        Chain = DAG.getMemcpy(Chain, dl, PtrDst, Arg, Size, align, false, false,
                              false, dstInfo, srcInfo);
        // replace Arg
  ...
  // operands of the call (the first two slots empty for now, we'll fill later
  // with chain and callee)
  ...
  for (int i = ArgLocs.size() - 1; i >= 0; --i) {
    ...
    if (VA.isMemLoc()) {
      ...
      if (isTailCall) {
        ...
        FixedStackPseudoSourceValue *fspsv =
            new FixedStackPseudoSourceValue(FI, *CTM.getInstrInfo());
        // store
  ...
  if (!isTailCall) {
    ...
    const auto& F = getFunction(Callee);
    const auto *CRI =
        static_cast<const CodasipRegisterInfo *>(CTM.getRegisterInfo());
    const uint32_t *Mask = CRI->getCallPreservedMask(F);
  ...
  Chain =
      DAG.getCALLSEQ_END(Chain, DAG.getIntPtrConstant(stackParamSize, dl, true),
...
static unsigned GetHwCl(unsigned id) {
  switch (id) {
  case Codasip::regsRegClassID:
    return Codasip::rf_gprRegClassID;
...
SDValue CodasipGenTargetLowering::LowerFormalArguments(
  ...
  for (unsigned i = 0, e = ArgLocs.size(); i != e; ++i) {
    ...
    // mem params
      ...
      InVals.push_back(DAG.getLoad(vt, dl, Chain, FIN,
  ...
  if (isVarArg) {
    int FI =
        MFI->CreateFixedObject(4,
                               finfo->ArgsInfo.StackOff, true);
  ...
  if (func.hasStructRetAttr()) {
    if (!finfo->StrctRetReg) {
      ...
      finfo->StrctRetReg =
          MRI.createVirtualRegister(TRI->getPointerRegClass(MF, true));
      assert(finfo->StrctRetReg);
    }
    SDValue Copy =
        DAG.getCopyToReg(DAG.getEntryNode(), dl, finfo->StrctRetReg, InVals[0]);
...
SDValue CodasipGenTargetLowering::LowerOperation(SDValue Op,
                                                 SelectionDAG &DAG) const {
  SDLoc dl(Op);
  MachineFunction &MF = DAG.getMachineFunction();
  ...
  case ISD::GlobalAddress: {
    ...
    SDValue tga = DAG.getTargetGlobalAddress(
        ga->getGlobal(), dl, MVT::i32,
        ga->getOffset());
    // lower the original (will be done in the caller method) to wrapper, use
    // the copy (tga) as an operand
    res = DAG.getNode(CodasipISD::GAWrap, dl,
                      MVT::i32, tga);
    break;
  }
  case ISD::ExternalSymbol: {
    ...
    SDValue tes = DAG.getTargetExternalSymbol(
        es->getSymbol(), MVT::i32,
        es->getTargetFlags());
    res = DAG.getNode(CodasipISD::GAWrap, dl,
                      MVT::i32, tes);
    break;
  ...
  case ISD::JumpTable: {
    ...
    SDValue tjt = DAG.getTargetJumpTable(
        jt->getIndex(), MVT::i32);
    res = DAG.getNode(CodasipISD::GAWrap, dl,
                      MVT::i32, tjt);
    break;
  ...
  case ISD::ConstantPool: {
    ...
    SDValue tcp =
        DAG.getTargetConstantPool(cp->getConstVal(), Op.getValueType(),
  ...
  case ISD::BlockAddress: {
    ...
    assert(ba);
    SDValue tba = DAG.getBlockAddress(ba->getBlockAddress(), Op.getValueType(),
                                      ba->getOffset(), true);
    res = DAG.getNode(CodasipISD::GAWrap, dl,
                      MVT::i32, tba);
    break;
  ...
  case ISD::GlobalTLSAddress: {
    ...
    const GlobalVariable *gv =
        static_cast<const GlobalVariable *>(ga->getGlobal());
  ...
  case ISD::RETURNADDR: {
    ...
    assert(op.getOpcode() == ISD::Constant &&
           "Invalid return/frame address usage.");
    const ConstantSDNode *hlp =
        static_cast<const ConstantSDNode *>(op.getNode());
    if (hlp->getZExtValue()) {
      errs() << "Builtin return/frame address can be only used with parameter "
                "0.\n";
      exit(1);
    }
    // ptr mvt
    ...
    if (Op.getOpcode() == ISD::FRAMEADDR) {
      ...
      assert(FL->hasFP(MF));
      res = DAG.getCopyFromReg(DAG.getEntryNode(), dl, RI->getFrameRegister(MF),
                               ptrT);
    } else {
  ...
  case ISD::VASTART: {
    SDValue FI =
        DAG.getFrameIndex(FuncInfo->ArgsInfo.StackFI, getPointerTy(td, 0));
    // vastart just stores the address of the VarArgsFrameIndex slot into the
    // memory location argument.
    const Value *SV = cast<SrcValueSDNode>(Op.getOperand(2))->getValue();
    res = DAG.getStore(Op.getOperand(0), dl, FI, Op.getOperand(1),
  ...
  case ISD::EH_SJLJ_SETUP_DISPATCH:
    ...
    return DAG.getNode(CodasipISD::EH_SJLJ_SETUP_DISPATCH, dl, MVT::Other,
                       Op.getOperand(0), Op.getOperand(1));
    break;
  ...
  case ISD::STORE:
  case ISD::LOAD:
    errs() << "This program requires an unimplemented load/store operation "
              "(see the log from backendgen).\n";
    errs() << "Please do implement custom lowering in "
              "CodasipTargetLowering::LowerOperation.\n";
    exit(1);
  // intrinsics
...
SDValue CodasipGenTargetLowering::HandleExtToCust(SDValue Op,
                                                  SelectionDAG &DAG) const {
...
EVT CodasipGenTargetLowering::getSetCCResultType(const DataLayout &DL,
                                                 LLVMContext &Context,
                                                 EVT VT) const {
  if (VT.isVector()) {
...
bool CodasipGenTargetLowering::isShuffleMaskLegal(ArrayRef<int> m,
                                                  EVT t) const {
...
return "MOI_GROUP_3";
case CodasipISD::MOI_GROUP_4:
return "MOI_GROUP_4";
case CodasipISD::MOI_GROUP_5:
return "MOI_GROUP_5";
case CodasipISD::MOI_GROUP_6:
return "MOI_GROUP_6";
case CodasipISD::MOI_GROUP_7:
return "MOI_GROUP_7";
case CodasipISD::MOI_GROUP_8:
return "MOI_GROUP_8";
case CodasipISD::MOI_GROUP_9:
return "MOI_GROUP_9";
case CodasipISD::MOI_GROUP_10:
return "MOI_GROUP_10";
case CodasipISD::MOI_GROUP_11:
return "MOI_GROUP_11";
...
CodasipGenTargetLowering::getRegForInlineAsmConstraint(
  ...
  if (!p.second) {
    errs() << "Invalid/unsupported inline-asm constraint: " << Constraint
           << ".\n";
    errs() << "Note: It's possible that this constraint was allowed in Clang "
              "but failed in finer analysis.\n";
  }
  return p;
}

unsigned CodasipGenTargetLowering::getInlineAsmMemConstraint(
...
unsigned CodasipGenTargetLowering::getRegisterByName(const char *RegName,
                                                     EVT VT,
                                                     SelectionDAG &DAG) const {
  ...
  if (reg == 0) {
    ...
    report_fatal_error(
        "Invalid register name used in global variable constraint.");
  }
  // get reserveds
  ...
  if (!res[reg]) {
    errs()
        << "Register " << RegName
        << " is not reserved but is used for register-bound global variable.\n";
  }
  return reg;
}

unsigned
CodasipGenTargetLowering::getRegisterByName(const char *RegName) const {
  RcAndReg p = GetRegAndClassByName(RegName, MVT::Other);
  // caller will check
  return p.first;
}

bool CodasipGenTargetLowering::StrCaseInsensitive::operator()(
    const StringRef left, const StringRef right) const {
  return left.compare_lower(right) < 0;
}

// VT may be Other
// note: this can be improved further
CodasipGenTargetLowering::RcAndReg
CodasipGenTargetLowering::GetRegAndClassByName(StringRef RegName,
                                               EVT VT) const {
  auto &CTM = static_cast<const CodasipTargetMachine &>(getTargetMachine());
  const TargetRegisterInfo *TRI = CTM.getRegisterInfo();
  // c++ pair
...
MachineBasicBlock *CodasipGenTargetLowering::EmitInstrWithCustomInserter(
  ...
  if (!check) {
    assert(
        false &&
        "failed to expand pseudo instruction in EmitInstrWithCustomInserter");
    return NULL;
  }
 ...
 * Note: Every type needs to be transformed into a smaller type (of half the
 * size ideally, but no smaller than that) */
void CodasipGenTargetLowering::computeRegisterProperties(
  ...
  for (unsigned i = MVT::FIRST_CUSTOM_INTEGER_VALUETYPE;
       i <= MVT::LAST_CUSTOM_INTEGER_VALUETYPE; ++i) {
    ...
    // non-legal
      ...
      // non-simple types are(/were) implicitly Expand - it should work like
      // that again
  ...
  // new vectors
  for (unsigned i = MVT::FIRST_CUSTOM_INTEGER_VECTOR_VALUETYPE;
       i <= MVT::LAST_CUSTOM_INTEGER_VECTOR_VALUETYPE; ++i) {
...
CodasipGenTargetLowering::getRegClassFor(MVT t, bool) const {
  if (t==MVT::i32) return &Codasip::regsRegClass;
  if (t==MVT::i32) return &Codasip::rf_gprRegClass;
  
  errs() << "Type " << EVT(t).getEVTString()
         << " is not supported. Implement "
            "CodasipTargetLowering::getRegClassFor.\n";
  exit(1);
  return TargetLowering::getRegClassFor(t);
}

const TargetRegisterClass *
CodasipGenTargetLowering::getRepRegClassFor(MVT t) const {
  if (t==MVT::i32) return &Codasip::regsRegClass;
  if (t==MVT::i32) return &Codasip::rf_gprRegClass;
  
  errs() << "Type " << EVT(t).getEVTString()
         << " is not supported. Implement "
            "CodasipTargetLowering::getRepRegClassFor.\n";
  exit(1);
  return TargetLowering::getRepRegClassFor(t);
}

bool CodasipGenTargetLowering::getTgtMemIntrinsic(IntrinsicInfo &ret,
                                                  const CallInst &inst,
                                                  MachineFunction &MF,
                                                  unsigned mainCode) const {
  ...
  ret.opc = (inst.getType()->isVoidTy() ? ISD::INTRINSIC_VOID
  ...
  for (const SDNode &n : sem->allnodes()) {
    if (n.getOpcode() == ISD::LOAD || n.getOpcode() == ISD::STORE) {
      ...
      ret.flags = (n.getOpcode() == ISD::LOAD ? MachineMemOperand::MOLoad
...
SDValue CodasipGenTargetLowering::LowerIntrinsic(SDValue Op,
                                                 SelectionDAG &DAG) const {
  const CodasipTargetMachine &CTM =
      static_cast<const CodasipTargetMachine &>(getTargetMachine());
  const CodasipInstrInfo *CII = CTM.getInstrInfo();
  ...
  if (Op.getOpcode() != ISD::INTRINSIC_WO_CHAIN)
    ops.push_back(Op.getOperand(0));
  // - input data
  for (unsigned i = auxInfo.SubcodeIndex + 1, j = 0; i < Op.getNumOperands();
       ++i, ++j) {
...
struct CodasipMemSDNode_5 : public MemSDNode{
  CodasipMemSDNode_5(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(5 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_6 : public MemSDNode{
  CodasipMemSDNode_6(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(6 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_7 : public MemSDNode{
  CodasipMemSDNode_7(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(7 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_8 : public MemSDNode{
  CodasipMemSDNode_8(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(8 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_9 : public MemSDNode{
  CodasipMemSDNode_9(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(9 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_10 : public MemSDNode{
  CodasipMemSDNode_10(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(10 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_11 : public MemSDNode{
  CodasipMemSDNode_11(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(11 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};

struct CodasipMemSDNode_12 : public MemSDNode{
  CodasipMemSDNode_12(unsigned Order, const DebugLoc &dl, SDVTList VTs,
                               EVT MemVT, MachineMemOperand *MMO) :
      MemSDNode(12 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE, Order, dl,
                VTs, MemVT, MMO){}
};
...
SDValue CodasipGenTargetLowering::GetCodasipMemSDNode(
  ...
  case 5 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_5>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 6 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_6>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 7 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_7>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 8 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_8>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 9 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_9>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 10 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_10>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 11 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_11>(VTs, Ops, dl,
                                                                MemVT, MMO);
  
  case 12 + CodasipISD::FIRST_TARGET_MEMORY_OPCODE:
    return DAG.getTargetMemSDNode<CodasipMemSDNode_12>(VTs, Ops, dl,
                                                                MemVT, MMO);
...
bool CodasipGenTargetLowering::isOffsetFoldingLegal(
...
bool CodasipGenTargetLowering::EmittArrayAccess(
    SelectionDAG &DAG, const User &I, Type *indexedType, const Value *Idx,
    SDValue IdxN, SDValue &N, const SDLoc &dl) const {
...
CodasipGenTargetLowering::ExpandCustomUnalignedLoad(LoadSDNode *LD,
                                                    SelectionDAG &DAG) const {
  ...
  errs() << "Unaligned packed custom int load: not implemented for "
            "little-endians\n";
  abort();
  ...
  SDValue ShiftAmount =
      DAG.getConstant(BYTE_SIZE, dl, getShiftAmountTy(VT, DAG.getDataLayout()));
  ...
  for (unsigned i = 0; i * BYTE_SIZE < NumBits; ++i) {
    ...
    SDValue load = DAG.getExtLoad(
        ExtType, dl, VT, Chain, Ptr, LD->getPointerInfo().getWithOffset(i),
        NewLoadedVT, BYTE_SIZE, LD->getMemOperand()->getFlags(),
        LD->getAAInfo());
...
SDValue
CodasipGenTargetLowering::ExpandCustomUnalignedStore(StoreSDNode *ST,
                                                     SelectionDAG &DAG) const {
  ...
  errs() << "Unaligned packed custom int store: not implemented for "
            "little-endians\n";
  abort();
  ...
  for (unsigned i = 0; i * BYTE_SIZE < NumBits; ++i) {
    SDValue ShiftAmount =
        DAG.getConstant((NumBytes - i - 1) * BYTE_SIZE, dl,
                        getShiftAmountTy(VT, DAG.getDataLayout()));
    SDValue Value = DAG.getNode(ISD::SRL, dl, VT, Val, ShiftAmount);
    SDValue store = DAG.getTruncStore(
        Chain, dl, Value, Ptr, ST->getPointerInfo().getWithOffset(i),
        NewStoredVT, Alignment, ST->getMemOperand()->getFlags());
    Ops.push_back(store);
    Ptr = DAG.getNode(ISD::ADD, dl, Ptr.getValueType(), Ptr,
                      DAG.getConstant(1, dl, Ptr.getValueType()));
  }
...
void CodasipGenTargetLowering::InitIndOffsetInfo() {
  // This is switchable by sub-target features (command line options)
  const CodasipTargetMachine &CTM =
      static_cast<const CodasipTargetMachine &>(getTargetMachine());
  const CodasipSubtarget &CST = *CTM.getSubtargetImpl();
  // Coarse grained legality data and implementing instructions.
  // Address spaces (and SFs) are taken into account.
  for (auto& table : IndexedOperationsInfo)
    for (auto& mode : table)
      for (auto& type : mode.Legalities)
        type.fill(false);
  
}

// Coarse grained legality and address space for Pre/PostIndexedAddressParts.
// This isn't a mere optimization - it takes custom legality into account.
bool CodasipGenTargetLowering::CheckIndexedLegal(LSBaseSDNode *N,
                                                 ISD::MemIndexedMode AM) const {
  EVT Vt = N->getMemoryVT();
  // This will reflect changing legality to expand in custom lowering info.
  ...
  const MVT Mvt = Vt.getSimpleVT();
  const unsigned Load = (N->getOpcode() == ISD::LOAD ? 1 : 0);
  const unsigned Space = N->getAddressSpace();
  return IndexedOperationsInfo.at(Load)
      .at(AM)
      .Legalities.at(Mvt.SimpleTy)
      .at(Space);
}

// Fine grained check for Pre/PostIndexedAddressParts
bool CodasipGenTargetLowering::CheckIndexedOffsetLegal(
  ...
  // Compare the tree in the offset with possible candidates.
  // Subtarget features have been handled in init of this map.
  // All the candidates have exactly one memory operation unless the file was
  // manually edited.
  const auto &Patts =
      IndexedOperationsInfo.at(Load).at(AM).Instructions.at(Space);
  for (const auto CandidateOpcode : Patts) {
    // Get the pattern
    std::vector<SDValue> Roots;
    SelectionDAG *Dag = GetCodasipPattern(TM, MF, CandidateOpcode, Roots);
    // Get the memnode (there's exactly one)
    const SDNode *PattMemN = nullptr;
    for (const SDNode &Node : Dag->allnodes()) {
      if (Node.getOpcode() == ISD::LOAD || Node.getOpcode() == ISD::STORE) {
        // Corrupted map of instructions.
        if (PattMemN)
          return false;
        // Mark the node
        PattMemN = &Node;
    ...
    if (PattMemN == nullptr)
      return false;
    assert(PattMemN->getOpcode() == N->getOpcode() &&
           "The map of indexed instructions is corrupted");
    // N is still a normal load/store, automatic matching wouldn't match.
    if (PattMemN->getOpcode() == ISD::LOAD) {
      auto *RealNode = cast<LoadSDNode>(N);
      auto *PattNode = cast<LoadSDNode>(PattMemN);
      if (RealNode->getExtensionType() != PattNode->getExtensionType())
        continue;
    } else if (PattMemN->getOpcode() == ISD::STORE) {
      auto *RealNode = cast<StoreSDNode>(N);
      auto *PattNode = cast<StoreSDNode>(PattMemN);
      if (PattNode->isTruncatingStore() != RealNode->isTruncatingStore())
        continue;
    } else {
      assert(false && "neither store nor load node");
    }
    if (cast<MemSDNode>(N)->getMemoryVT() !=
        cast<MemSDNode>(PattMemN)->getMemoryVT())
      continue;
    // Create wrapper object
    // PattMeta (see BaseDagPattern) is instr opcode and a moi group.
    // Moi group isn't used in MatchTreeWithOperands.
    int PattMeta[2] = {int(CandidateOpcode), ISD::FIRST_TARGET_MEMORY_OPCODE};
    const auto &CTM =
        static_cast<const CodasipTargetMachine &>(getTargetMachine());
    DagPattern Pat(Dag, PattMeta, CTM, Roots);
    // The base must be matched first to make checking of parameters work.
    SDValue PattBase = cast<MemSDNode>(PattMemN)->getBasePtr();
    SDValue RealBase = N->getBasePtr();
    if (!Pat.MatchTree(PattBase, RealBase, &CurDAG))
      continue;
    // Match the offsets
    SDValue PattOffset = cast<LSBaseSDNode>(PattMemN)->getOffset();
    if (Pat.MatchTreeWithOperands(PattOffset, Offset, CurDAG))
      return true;
  }
  return false;
}

bool CodasipGenTargetLowering::getPreIndexedAddressParts(
    SDNode *Node, SDValue &BasePtr, SDValue &Offset, ISD::MemIndexedMode &AM,
    SelectionDAG &DAG) const {
  ...
  // fine grained check
  if (!CheckIndexedOffsetLegal(lsb, AM, Offset, DAG)) {
    return false;
  }
  // llvm also swaps it
  if (swaped) {
...
bool CodasipGenTargetLowering::getPostIndexedAddressParts(
    SDNode *Node, SDNode *Op, SDValue &BasePtr, SDValue &Offset,
...
bool CodasipGenTargetLowering::canMergeStoresTo(unsigned AS, EVT MemVT,
                                                const SelectionDAG &) const {
...
MVT CodasipGenTargetLowering::getScalarShiftAmountTy(const DataLayout &DL,
                                                     EVT t) const {
  /*if (t.isSimple()) {
...
bool CodasipGenTargetLowering::isLegalAddressingMode(const DataLayout &DL,
  ...
  if (AM.BaseOffs <= -(1LL << 12) ||
      AM.BaseOffs >= (1LL << 12) - 1) {
    return false;
  }
...
void CodasipGenTargetLowering::EmitEssentialLoad(
...
void CodasipGenTargetLowering::EmitEssentialStore(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI, DebugLoc &DL,
    const CodasipInstrInfo &CII, unsigned Data, unsigned Addr,
    int64_t Imm) const {
  SmallVector<MachineOperand, 3> ops;
...
void CodasipGenTargetLowering::EmitEssentialAdd(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI, DebugLoc &DL,
    const CodasipInstrInfo &CII, unsigned Dst, unsigned Src,
    unsigned Src2) const {
  SmallVector<MachineOperand, 3> ops;
...
void CodasipGenTargetLowering::EmitIndirectJump(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI, DebugLoc &DL,
  ...
  CII.getCodasipInstr(JmpOps, ISD::BRIND,
                      getPointerTy(MBB.getParent()->getDataLayout()));
  for (std::vector<int>::iterator it = JmpOps.begin(); it != JmpOps.end();
       ++it) {
    ...
    if (JumpOp.getNumOperands() == 2 &&
        JumpOp.OpInfo[0].OperandType == MCOI::OPERAND_IMMEDIATE &&
        JumpOp.OpInfo[1].RegClass == RCId) {
      BuildMI(MBB, MBBI, DL, JumpOp).addReg(Target).addImm(0);
      return;
    }
  }
...
void CodasipGenTargetLowering::EmitLoad32(MachineBasicBlock &MBB,
                                          MachineBasicBlock::iterator MBBI,
                                          DebugLoc &DL, unsigned Target,
                                          int Source, int Imm, bool FI) const {
  ...
  if (PVT == MVT::i64) {
    ...
    for (std::vector<int>::iterator it = LoadOps.begin(); it != LoadOps.end();
         ++it) {
      const MCInstrDesc &LoadOp = TII.get(*it);
      if (LoadOp.OpInfo[2].OperandType == MCOI::OPERAND_IMMEDIATE &&
          LoadOp.OpInfo[0].RegClass == (int)RC32->getID()) {
    ...
    llvm_unreachable(
        "Unknown loadw variant, there should be rf32 = loadw fi, imm!");
  } else {
    if (FI) {
      unsigned Tmp = MRI->createVirtualRegister(RC);
      EmitEssentialLoad(MBB, MBB.end(), DL, CII, Target, Tmp, Imm);
      for (auto it = MBB.instr_back().operands_end();
           it != MBB.instr_back().operands_begin() + 1;) {
...
void CodasipGenTargetLowering::EmitLoadImm32(MachineBasicBlock &MBB,
                                             MachineBasicBlock::iterator MBBI,
                                             DebugLoc &DL, unsigned Dst,
                                             int Imm) const {
  MachineFunction *MF = MBB.getParent();
  MachineRegisterInfo *MRI = &MF->getRegInfo();
  const CodasipTargetMachine &CTM =
...
// Based on PowerPC
MachineBasicBlock *
CodasipGenTargetLowering::emitEHSjLjLongJmp(MachineInstr &MI,
...
MachineBasicBlock *
CodasipGenTargetLowering::emitEHSjLjSetJmp(MachineInstr &MI,
                                           MachineBasicBlock *MBB) const {
  DebugLoc dl = MI.getDebugLoc();
  const CodasipTargetMachine &CTM =
      static_cast<const CodasipTargetMachine &>(getTargetMachine());
  ...
  for (auto it = MIB.getInstr()->operands_end();
       it != MIB.getInstr()->operands_begin();) {
  ...
  // Store IP
  EmitEssentialStore(*mainMBB, mainMBB->begin(), dl, CII, LabelReg, BufReg,
                     LabelOffset);
  EmitLoadImm32(*mainMBB, mainMBB->end(), dl, mainDstReg, 0);

  mainMBB->addSuccessor(sinkMBB);
  // sinkMBB:
  BuildMI(*sinkMBB, sinkMBB->begin(), dl, TII.get(Codasip::PHI), DstReg)
      .addReg(mainDstReg)
      .addMBB(mainMBB)
...
const MCExpr *CodasipGenTargetLowering::LowerCustomJumpTableEntry(
...
void CodasipGenTargetLowering::SetupEntryBlockForSjLj(
    MachineInstr &MI, MachineBasicBlock *MBB, MachineBasicBlock *DispatchBB,
    int FI) const {
  DebugLoc DL = MI.getDebugLoc();
  MachineFunction *MF = MBB->getParent();
  MachineRegisterInfo *MRI = &MF->getRegInfo();
...
MachineBasicBlock *
CodasipGenTargetLowering::emitEHSjLjDispatchBlock(MachineInstr &MI,
  ...
  // This instruction is provided for software testing to explicitly generate an
  // invalid opcode. The opcode for this instruction is reserved for this
  // purpose.
  BuildMI(TrapBB, dl, TII.get(getLongJumpOpcodeStatic()))
      .addExternalSymbol("abort");
  DispatchBB->addSuccessor(TrapBB);

  MachineBasicBlock *DispContBB =
      MF->CreateMachineBasicBlock(BB->getBasicBlock());
  ...
  DispatchBB->instr_back().addOperand(
      *MF, MachineOperand::CreateRegMask(RI.getNoPreservedMask()));
  ...
  for (std::vector<int>::iterator it = CondJumpOps.begin(); it != CondJumpOps.end(); ++it) {
    ...
    if (CondJumpOp.getNumOperands() == 3 &&
        CondJumpOp.OpInfo[0].RegClass == RCId &&
  ...
  for (std::vector<int>::iterator it = Shift.begin(); it != Shift.end(); ++it) {
    ...
    if (ShiftOp.getNumOperands() == 3 && ShiftOp.OpInfo[0].RegClass == RCId &&
      ...
      MIB = BuildMI(DispContBB, dl, ShiftOp, Offset)
                ...
                .addImm(shiftSize);
      break;
    } else if (ShiftOp.getNumOperands() == 3 &&
               ShiftOp.OpInfo[0].RegClass == RCId &&
               ShiftOp.OpInfo[1].RegClass == RCId &&
               ShiftOp.OpInfo[2].RegClass == RCId) {
  ...
  case MachineJumpTableInfo::EK_LabelDifference32: {
    ...
    EmitEssentialAdd(*DispContBB, DispContBB->end(), dl, CII, RelAddr,
                     JumpTarget, MJTIAddr);
...
unsigned CodasipGenTargetLowering::getExceptionPointerRegister(
    const Constant *PersonalityFn) const {
  // clang-format off
  return Codasip::rf_gpr_10;
  // clang-format on
}

unsigned CodasipGenTargetLowering::getExceptionSelectorRegister(
    const Constant *PersonalityFn) const {
  // clang-format off
  return Codasip::rf_gpr_11;
  // clang-format on
}
...
Value *
CodasipGenTargetLowering::getSafeStackPointerLocation(IRBuilder<> &IRB) const {
  return getDefaultSafeStackPointerLocation(IRB, /*ThreadLocalStorage*/ false);
}

DagPattern::DagPattern(SelectionDAG *DAG, int *PattInfo, const CodasipTargetMachine &TM,
                       ValueVec &Roots)
: BaseDagPattern(DAG, PattInfo, TM, Roots), CTM(TM) {}

ImmInfo DagPattern::GetImmInfo(unsigned Opcode, unsigned OpNum) {
  ImmInfo Info = {0, false, 0};
  CTM.getInstrInfo()->GetImmProperties(Opcode, OpNum, Info.width, Info.sign,
                                       Info.trunc);
  return Info;
}

bool DagPattern::CheckImmWidth(int64_t Val, int Width, bool Sign, int Trunc) {
  return CheckImmImpl(Val, Width, Sign, Trunc);
}

const TargetRegisterClass *DagPattern::GetRegClass(int RC) {
