...
public:
  ...
  unsigned getEquivalentCondOpcode(ArrayRef<MachineOperand> Cond,
                                   int RegPos) const override;
  /// Use this to add/override pseudo insertions
  bool ExpandDummiesImpl(MachineInstr *MIp, MachineBasicBlock *&BB,
                         const bool postRA) const override;
};
